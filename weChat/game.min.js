...
this.removeEventListener("error",g,!1);c&&c(null,e)},g=function(){this.removeEventListener("error",g,!1);e.crossOrigin&&"anonymous"==e.crossOrigin.toLowerCase()?(d.isCrossOrigin=!1,cc.loader.loadImg(a,d,c)):"function"==typeof c&&c("load image failed")};cc._addEventListener(e,"load",f);cc._addEventListener(e,"error",g);e.src=a;return e},_loadResIterator:function(a,b,c){var d=this,e=null,f=a.type;f?(f="."+f.toLowerCase(),e=a.src?a.src:a.name+f):(e=a,f=cc.path.extname(e));if(b=d.cache[e])return c(null,
b);b=null;f&&(b=d._register[f.toLowerCase()]);if(!b)return cc.error("loader for ["+f+"] not exists!"),c();f=b.getBasePath?b.getBasePath():d.resPath;f=d.getUrl(f,e);b.load(f,e,a,function(a,b){a?(cc.log(a),d.cache[e]=null,delete d.cache[e],c()):(d.cache[e]=b,c(null,b))})},getUrl:function(a,b){var c=this._langPathCache,d=cc.path;if(void 0!==a&&void 0===b){b=a;var e=d.extname(b),e=e?e.toLowerCase():"";a=(e=this._register[e])?e.getBasePath?e.getBasePath():this.resPath:this.resPath}b=cc.path.join(a||"",
b);if(b.match(/[\/(\\\\)]lang[\/(\\\\)]/i)){if(c[b])return c[b];d=d.extname(b)||"";b=c[b]=b.substring(0,b.length-d.length)+"_"+cc.sys.language+d}return b},load:function(a,b,c){var d=this,e=arguments.length;if(0==e)throw"arguments error!";3==e?"function"==typeof b&&(b="function"==typeof c?{trigger:b,cb:c}:{cb:b,cbTarget:c}):2==e?"function"==typeof b&&(b={cb:b}):1==e&&(b={});a instanceof Array||(a=[a]);e=new cc.AsyncPool(a,0,function(a,c,e,k){d._loadResIterator(a,c,function(a){if(a)return e(a);var c=
Array.prototype.slice.call(arguments,1);b.trigger&&b.trigger.call(b.triggerTarget,c[0],k.size,k.finishedSize);e(null,c[0])})},b.cb,b.cbTarget);e.flow();return e},_handleAliases:function(a,b){var c=this._aliases,d=[],e;for(e in a){var f=a[e];c[e]=f;d.push(f)}this.load(d,b)},loadAliases:function(a,b){var c=this,d=c.getRes(a);d?c._handleAliases(d.filenames,b):c.load(a,function(a,d){c._handleAliases(d[0].filenames,b)})},register:function(a,b){if(a&&b){if("string"==typeof a)return this._register[a.trim().toLowerCase()]=
...
this._rpFixedWidth)}},setDesignResolutionSize:function(a,b,c){isNaN(a)||0==a||isNaN(b)||0==b?cc.log(cc._LogInfos.EGLView_setDesignResolutionSize):(this.setResolutionPolicy(c),(c=this._resolutionPolicy)?(c.preApply(this),cc.sys.isMobile&&this._setViewPortMeta(this._frameSize.width,this._frameSize.height),this._initFrameSize(),this._designResolutionSize=cc.size(a,b),this._originalDesignResolutionSize=cc.size(a,b),a=c.apply(this,this._designResolutionSize),a.scale&&2==a.scale.length&&(this._scaleX=a.scale[0],
this._scaleY=a.scale[1]),a.viewport&&(a=this._viewPortRect=a.viewport,b=this._visibleRect,b.width=cc._canvas.width/this._scaleX,b.height=cc._canvas.height/this._scaleY,b.x=-a.x/this._scaleX,b.y=-a.y/this._scaleY),a=cc.director,cc.winSize.width=a._winSizeInPoints.width=this._visibleRect.width,cc.winSize.height=a._winSizeInPoints.height=this._visibleRect.height,c.postApply(this),cc._renderType==cc._RENDER_TYPE_WEBGL&&(a._createStatsLabel(),a.setGLDefaultValues()),this._originalScaleX=this._scaleX,this._originalScaleY=
this._scaleY,cc.DOM&&cc.DOM._resetEGLViewDiv(),cc.visibleRect&&cc.visibleRect.init(this._visibleRect)):cc.log(cc._LogInfos.EGLView_setDesignResolutionSize_2))},getDesignResolutionSize:function(){return cc.size(this._designResolutionSize.width,this._designResolutionSize.height)},setViewPortInPoints:function(a,b,c,d){var e=this._frameZoomFactor,f=this._scaleX,g=this._scaleY;cc._renderContext.viewport(a*f*e+this._viewPortRect.x*e,b*g*e+this._viewPortRect.y*e,c*f*e,d*g*e)},setScissorInPoints:function(a,
b,c,d){var e=this._frameZoomFactor,f=this._scaleX,g=this._scaleY;cc._renderContext.scissor(a*f*e+this._viewPortRect.x*e,b*g*e+this._viewPortRect.y*e,c*f*e,d*g*e)},isScissorEnabled:function(){var a=cc._renderContext;return a.isEnabled(a.SCISSOR_TEST)},getScissorRect:function(){var a=cc._renderContext,b=this._scaleX,c=this._scaleY,a=a.getParameter(a.SCISSOR_BOX);return cc.rect((a[0]-this._viewPortRect.x)/b,(a[1]-this._viewPortRect.y)/c,a[2]/b,a[3]/c)},setViewName:function(a){null!=a&&0<a.length&&(this._viewName=
a)},getViewName:function(){return this._viewName},getViewPortRect:function(){return this._viewPortRect},getScaleX:function(){return this._scaleX},getScaleY:function(){return this._scaleY},getDevicePixelRatio:function(){return this._devicePixelRatio},convertToLocationInView:function(a,b,c){return{x:this._devicePixelRatio*(a-c.left),y:this._devicePixelRatio*(c.top+c.height-b)}},_convertMouseToLocationInView:function(a,b){var c=this._viewPortRect;a.x=(this._devicePixelRatio*(a.x-b.left)-c.x)/this._scaleX;
a.y=(this._devicePixelRatio*(b.top+b.height-a.y)-c.y)/this._scaleY},_convertTouchesWithScale:function(a){for(var b=this._viewPortRect,c=this._scaleX,d=this._scaleY,e,f,g,h=0;h<a.length;h++)e=a[h],f=e._point,g=e._prevPoint,e._setPoint((f.x-b.x)/c,(f.y-b.y)/d),e._setPrevPoint((g.x-b.x)/c,(g.y-b.y)/d)}});cc.EGLView._getInstance=function(){this._instance||(this._instance=this._instance||new cc.EGLView,this._instance.initialize());return this._instance};
...
this.onKeyPressed&&null==this.onKeyReleased?(cc.log(cc._LogInfos._EventListenerKeyboard_checkAvailable),!1):!0}});cc._EventListenerKeyboard.LISTENER_ID="__cc_keyboard";cc._EventListenerKeyboard.create=function(){return new cc._EventListenerKeyboard};cc._renderType===cc._RENDER_TYPE_CANVAS&&(cc.rendererCanvas={childrenOrderDirty:!0,_transformNodePool:[],_renderCmds:[],_isCacheToCanvasOn:!1,_cacheToCanvasCmds:[],rendering:function(a){var b=this._renderCmds,c,d=cc.view.getScaleX(),e=cc.view.getScaleY(),f=a||cc._renderContext;a=0;for(c=b.length;a<c;a++)b[a].rendering(f,d,e)},_renderingToCacheCanvas:function(a){var b=this._cacheToCanvasCmds,c,d;a||cc.log("The context of RenderTexture is invalid.");c=0;for(d=b.length;c<d;c++)b[c].rendering(a,1,1);
b.length=0;this._isCacheToCanvasOn=!1},resetFlag:function(){this.childrenOrderDirty=!1;this._transformNodePool.length=0},transform:function(){var a=this._transformNodePool;a.sort(this._sortNodeByLevelAsc);for(var b=0,c=a.length;b<c;b++)a[b]._renderCmdDiry&&a[b]._transformForRenderer();a.length=0},transformDirty:function(){return 0<this._transformNodePool.length},_sortNodeByLevelAsc:function(a,b){return a._curLevel-b._curLevel},pushDirtyNode:function(a){this._transformNodePool.push(a)},clearRenderCommands:function(){this._renderCmds.length=
0},pushRenderCommand:function(a){this._isCacheToCanvasOn?-1===this._cacheToCanvasCmds.indexOf(a)&&this._cacheToCanvasCmds.push(a):-1===this._renderCmds.indexOf(a)&&this._renderCmds.push(a)}},cc.renderer=cc.rendererCanvas,cc.TextureRenderCmdCanvas=function(a){this._node=a;this._textureCoord={renderX:0,renderY:0,x:0,y:0,width:0,height:0,validRect:!1}},cc.TextureRenderCmdCanvas.prototype.rendering=function(a,b,c){var d=this._node;a=a||cc._renderContext;var e=this._textureCoord;if(e.validRect&&d._visible){var f=
d._transformWorld,g=d._offsetPosition.x,h=-d._offsetPosition.y-d._rect.height,k=d._rect.width,m=d._rect.height,n,q="source"!==d._blendFuncStr;1!==f.a||0!==f.b||0!==f.c||1!==f.d||d._flippedX||d._flippedY?(a.save(),a.transform(f.a,f.c,f.b,f.d,f.tx*b,-f.ty*c),q&&(a.globalCompositeOperation=d._blendFuncStr),d._flippedX&&a.scale(-1,1),d._flippedY&&a.scale(1,-1),d._texture?d._texture._isLoaded&&(a.globalAlpha=d._displayedOpacity/255,n=d._texture._htmlElementObj,d._colorized?a.drawImage(n,0,0,e.width,e.height,
g*b,h*c,k*b,m*c):a.drawImage(n,e.renderX,e.renderY,e.width,e.height,g*b,h*c,k*b,m*c)):d._texture||(e=d._color,a.fillStyle="rgba("+e.r+","+e.g+","+e.b+","+d._displayedOpacity+")",a.fillRect(g,h,k,m)),a.restore()):(q&&(a.save(),a.globalCompositeOperation=d._blendFuncStr),d._texture?d._texture._isLoaded&&(a.globalAlpha=d._displayedOpacity/255,n=d._texture.getHtmlElementObj(),d._colorized?a.drawImage(n,0,0,e.width,e.height,(f.tx+g)*b,(-f.ty+h)*c,k*b,m*c):a.drawImage(n,e.renderX,e.renderY,e.width,e.height,
(f.tx+g)*b,(-f.ty+h)*c,k*b,m*c)):!d._texture&&d._displayedColor&&(a.globalAlpha=d._displayedOpacity/255,e=d._displayedColor,a.fillStyle="rgba("+e.r+","+e.g+","+e.b+","+d._displayedOpacity+")",a.fillRect(f.tx*b+g,-f.ty*c+h,k,m)),q&&a.restore());cc.g_NumberOfDraws++}},cc.RectRenderCmdCanvas=function(a){this._node=a},cc.RectRenderCmdCanvas.prototype.rendering=function(a,b,c){a=a||cc._renderContext;var d=this._node,e=d._transformWorld,f=d._displayedColor,g=d._displayedOpacity/255,h=d._contentSize.width,
k=d._contentSize.height;a.save();"source"!=d._blendFuncStr&&(a.globalCompositeOperation=d._blendFuncStr);a.transform(e.a,e.c,e.b,e.d,e.tx*b,-e.ty*c);a.fillStyle="rgba("+(0|f.r)+","+(0|f.g)+","+(0|f.b)+","+g+")";a.fillRect(0,0,h*b,-k*c);a.restore();cc.g_NumberOfDraws++},cc.GradientRectRenderCmdCanvas=function(a){this._node=a;this._startPoint=cc.p(0,0);this._endPoint=cc.p(0,0)},cc.GradientRectRenderCmdCanvas.prototype.rendering=function(a,b,c){a=a||cc._renderContext;var d=this._node,e=d._transformWorld;
a.save();"source"!=d._blendFuncStr&&(a.globalCompositeOperation=d._blendFuncStr);a.transform(e.a,e.c,e.b,e.d,e.tx*b,-e.ty*c);var e=d._displayedOpacity/255,f=d._contentSize.width,g=d._contentSize.height,h=a.createLinearGradient(this._startPoint.x,this._startPoint.y,this._endPoint.x,this._endPoint.y),k=d._displayedColor,d=d._endColor;h.addColorStop(0,"rgba("+Math.round(k.r)+","+Math.round(k.g)+","+Math.round(k.b)+","+(k.a/255*e).toFixed(4)+")");h.addColorStop(1,"rgba("+Math.round(d.r)+","+Math.round(d.g)+
","+Math.round(d.b)+","+(null!=d.a?(d.a/255*e).toFixed(4):255)+")");a.fillStyle=h;a.fillRect(0,0,f*b,-g*c);a.restore();cc.g_NumberOfDraws++},cc.ParticleRenderCmdCanvas=function(a){this._node=a},cc.ParticleRenderCmdCanvas.prototype.rendering=function(a,b,c){a=a||cc._renderContext;var d=this._node,e=d._transformWorld,f=d._pointRect;a.save();a.transform(e.a,e.c,e.b,e.d,e.tx*b,-e.ty*c);d.isBlendAdditive()?a.globalCompositeOperation="lighter":a.globalCompositeOperation="source-over";b=this._node.particleCount;
c=this._node._particles;if(cc.ParticleSystem.SHAPE_MODE==cc.ParticleSystem.TEXTURE_MODE){if(!d._texture||!d._texture._isLoaded){a.restore();return}var g=d._texture.getHtmlElementObj();if(!g.width||!g.height){a.restore();return}for(var h=cc.textureCache,k=g,d=0;d<b;d++){e=c[d];a.globalAlpha=e.color.a/255;a.save();a.translate(0|e.drawPos.x,-(0|e.drawPos.y));var m=4*Math.floor(e.size/4),n=f.width,q=f.height;a.scale(Math.max(1/n*m,1E-6),Math.max(1/q*m,1E-6));e.rotation&&a.rotate(cc.degreesToRadians(e.rotation));
e.isChangeColor&&(m=h.getTextureColors(g))&&(m.tintCache||(m.tintCache=cc.newElement("canvas"),m.tintCache.width=g.width,m.tintCache.height=g.height),cc.generateTintImage(g,m,e.color,this._pointRect,m.tintCache),k=m.tintCache);a.drawImage(k,-(0|n/2),-(0|q/2));a.restore()}}else for(g=cc._drawingUtil,d=0;d<b;d++)e=c[d],f=0|0.5*e.size,a.globalAlpha=e.color.a/255,a.save(),a.translate(0|e.drawPos.x,-(0|e.drawPos.y)),cc.ParticleSystem.BALL_SHAPE==cc.ParticleSystem.STAR_SHAPE?(e.rotation&&a.rotate(cc.degreesToRadians(e.rotation)),
g.drawStar(a,f,e.color)):g.drawColorBall(a,f,e.color),a.restore();a.restore();cc.g_NumberOfDraws++},cc.ProgressRenderCmdCanvas=function(a){this._PI180=Math.PI/180;this._node=a;this._sprite=null;this._type=cc.ProgressTimer.TYPE_RADIAL;this._barRect=cc.rect(0,0,0,0);this._origin=cc.p(0,0);this._radius=0;this._endAngle=this._startAngle=270;this._counterClockWise=!1},cc.ProgressRenderCmdCanvas.prototype.rendering=function(a,b,c){a=a||cc._renderContext;var d=this._node,e=this._sprite,f=e._rendererCmd._textureCoord;
if(e._texture&&f.validRect){d=d._transformWorld;a.save();a.transform(d.a,d.c,d.b,d.d,d.tx*b,-d.ty*c);"source"!=e._blendFuncStr&&(a.globalCompositeOperation=e._blendFuncStr);a.globalAlpha=e._displayedOpacity/255;var g=e._rect,h=e._offsetPosition,d=e._drawSize_Canvas,k=0|h.x,m=-h.y-g.height;d.width=g.width*b;d.height=g.height*c;e._flippedX&&(k=-h.x-g.width,a.scale(-1,1));e._flippedY&&(m=h.y,a.scale(1,-1));k*=b;m*=c;this._type==cc.ProgressTimer.TYPE_BAR?(g=this._barRect,a.beginPath(),a.rect(g.x*b,g.y*
c,g.width*b,g.height*c),a.clip(),a.closePath()):this._type==cc.ProgressTimer.TYPE_RADIAL&&(b*=this._origin.x,g=this._origin.y*c,a.beginPath(),a.arc(b,g,this._radius*c,this._PI180*this._startAngle,this._PI180*this._endAngle,this._counterClockWise),a.lineTo(b,g),a.clip(),a.closePath());c=e._texture.getHtmlElementObj();a.drawImage(c,f.renderX,f.renderY,f.width,f.height,k,m,d.width,d.height);a.restore();cc.g_NumberOfDraws++}},cc.DrawNodeRenderCmdCanvas=function(a){this._node=a;this._blendFunc=this._drawColor=
this._buffer=null},cc.DrawNodeRenderCmdCanvas.prototype.rendering=function(a,b,c){a=a||cc._renderContext;this._blendFunc&&this._blendFunc.src==cc.SRC_ALPHA&&this._blendFunc.dst==cc.ONE&&(a.globalCompositeOperation="lighter");for(var d=0;d<this._buffer.length;d++){var e=this._buffer[d];switch(e.type){case cc.DrawNode.TYPE_DOT:this._drawDot(a,e,b,c);break;case cc.DrawNode.TYPE_SEGMENT:this._drawSegment(a,e,b,c);break;case cc.DrawNode.TYPE_POLY:this._drawPoly(a,e,b,c)}}},cc.DrawNodeRenderCmdCanvas.prototype._drawDot=
function(a,b,c,d){var e=b.fillColor,f=b.verts[0];b=b.lineWidth;a.fillStyle="rgba("+(0|e.r)+","+(0|e.g)+","+(0|e.b)+","+e.a/255+")";a.beginPath();a.arc(f.x*c,-f.y*d,b*c,0,2*Math.PI,!1);a.closePath();a.fill()},cc.DrawNodeRenderCmdCanvas.prototype._drawSegment=function(a,b,c,d){var e=b.lineColor,f=b.verts[0],g=b.verts[1],h=b.lineWidth;b=b.lineCap;a.strokeStyle="rgba("+(0|e.r)+","+(0|e.g)+","+(0|e.b)+","+e.a/255+")";a.lineWidth=h*c;a.beginPath();a.lineCap=b;a.moveTo(f.x*c,-f.y*d);a.lineTo(g.x*c,-g.y*
d);a.stroke()},cc.DrawNodeRenderCmdCanvas.prototype._drawPoly=function(a,b,c,d){var e=this._node,f=b.verts,g=b.lineCap,h=b.fillColor,k=b.lineWidth,m=b.lineColor,n=b.isClosePolygon,q=b.isFill;b=b.isStroke;if(null!=f){var r=f[0];a.lineCap=g;h&&(a.fillStyle="rgba("+(0|h.r)+","+(0|h.g)+","+(0|h.b)+","+h.a/255+")");k&&(a.lineWidth=k*c);m&&(a.strokeStyle="rgba("+(0|m.r)+","+(0|m.g)+","+(0|m.b)+","+m.a/255+")");e=e._transformWorld;a.save();a.transform(e.a,e.c,e.b,e.d,e.tx*c,-e.ty*d);a.beginPath();a.moveTo(r.x*
c,-r.y*d);e=1;for(g=f.length;e<g;e++)a.lineTo(f[e].x*c,-f[e].y*d);n&&a.closePath();q&&a.fill();b&&a.stroke();a.restore()}},cc.ClippingNodeSaveRenderCmdCanvas=function(a){this._node=a},cc.ClippingNodeSaveRenderCmdCanvas.prototype.rendering=function(a,b,c){var d=this._node;a=a||cc._renderContext;d._clipElemType?(b=cc.ClippingNode._getSharedCache(),c=a.canvas,b.width=c.width,b.height=c.height,b.getContext("2d").drawImage(c,0,0),a.save()):(d.transform(),d=d._transformWorld,a.save(),a.save(),a.transform(d.a,
d.c,d.b,d.d,d.tx*b,-d.ty*c))},cc.ClippingNodeClipRenderCmdCanvas=function(a){this._node=a},cc.ClippingNodeClipRenderCmdCanvas.prototype.rendering=function(a,b,c){var d=this._node;a=a||cc._renderContext;d._clipElemType?(a.globalCompositeOperation=d.inverted?"destination-out":"destination-in",d=d._transformWorld,a.transform(d.a,d.c,d.b,d.d,d.tx*b,-d.ty*c)):(a.restore(),d.inverted&&(b=a.canvas,a.save(),a.setTransform(1,0,0,1,0,0),a.moveTo(0,0),a.lineTo(0,b.height),a.lineTo(b.width,b.height),a.lineTo(b.width,
0),a.lineTo(0,0),a.restore()),a.clip())},cc.ClippingNodeRestoreRenderCmdCanvas=function(a){this._node=a},cc.ClippingNodeRestoreRenderCmdCanvas.prototype.rendering=function(a,b,c){b=this._node;c=cc.ClippingNode._getSharedCache();a=a||cc._renderContext;b._clipElemType&&(a.restore(),a.save(),a.setTransform(1,0,0,1,0,0),a.globalCompositeOperation="destination-over",a.drawImage(c,0,0));a.restore()},cc.PhysicsDebugNodeRenderCmdCanvas=function(a){this._node=a;this._buffer=a._buffer},cc.PhysicsDebugNodeRenderCmdCanvas.prototype.rendering=
function(a,b,c){var d=this._node;d._space&&(d._space.eachShape(cc.DrawShape.bind(d)),d._space.eachConstraint(cc.DrawConstraint.bind(d)),cc.DrawNodeRenderCmdCanvas.prototype.rendering.call(this,a,b,c),d.clear())},cc.PhysicsDebugNodeRenderCmdCanvas.prototype._drawDot=cc.DrawNodeRenderCmdCanvas.prototype._drawDot,cc.PhysicsDebugNodeRenderCmdCanvas.prototype._drawSegment=cc.DrawNodeRenderCmdCanvas.prototype._drawSegment,cc.PhysicsDebugNodeRenderCmdCanvas.prototype._drawPoly=cc.DrawNodeRenderCmdCanvas.prototype._drawPoly,
cc.TMXLayerRenderCmdCanvas=function(a){this._node=a;this._transform=a._transformWorld;this._childrenRenderCmds=[]},cc.TMXLayerRenderCmdCanvas.prototype._copyRendererCmds=function(a){if(a)for(var b=this._childrenRenderCmds,c=b.length=0,d=a.length;c<d;c++)b[c]=a[c]},cc.TMXLayerRenderCmdCanvas.prototype._renderingChildToCache=function(a,b){var c=this._node;if(c._cacheDirty){var d=this._childrenRenderCmds,e=c._cacheContext,f=c._cacheCanvas;e.save();e.clearRect(0,0,f.width,-f.height);f=cc.affineTransformInvert(this._transform);
e.transform(f.a,f.c,f.b,f.d,f.tx*a,-f.ty*b);for(var f=0,g=d.length;f<g;f++)d[f].rendering(e,a,b),d[f]._node&&(d[f]._node._cacheDirty=!1);e.restore();c._cacheDirty=!1}},cc.TMXLayerRenderCmdCanvas.prototype.rendering=function(a,b,c){this._renderingChildToCache(b,c);a=a||cc._renderContext;var d=this._node,e=0|-d._anchorPointInPoints.x,f=0|-d._anchorPointInPoints.y,d=d._cacheCanvas,g=this._transform;d&&(a.save(),a.transform(g.a,g.c,g.b,g.d,g.tx*b,-g.ty*c),c*=d.height,a.drawImage(d,0,0,d.width,d.height,
...
c);b=d._skeleton;var f,g,h=cc._drawingUtil;if(d._debugSlots){h.setDrawColor(0,0,255,255);h.setLineWidth(1);var k=[];c=0;for(e=b.slots.length;c<e;c++)g=b.drawOrder[c],g.attachment&&g.attachment.type==sp.ATTACHMENT_TYPE.REGION&&(f=g.attachment,sp._regionAttachment_updateSlotForCanvas(f,g,k),h.drawPoly(k,4,!0))}if(d._debugBones){h.setLineWidth(2);h.setDrawColor(255,0,0,255);c=0;for(e=b.bones.length;c<e;c++)d=b.bones[c],f=d.data.length*d.m00+d.worldX,g=d.data.length*d.m10+d.worldY,h.drawLine(cc.p(d.worldX,
d.worldY),cc.p(f,g));h.setPointSize(4);h.setDrawColor(0,0,255,255);c=0;for(e=b.bones.length;c<e;c++)d=b.bones[c],h.drawPoint(cc.p(d.worldX,d.worldY)),0===c&&h.setDrawColor(0,255,0,255)}a.restore()}});cc._renderType===cc._RENDER_TYPE_WEBGL&&(cc.rendererWebGL={childrenOrderDirty:!0,_transformNodePool:[],_renderCmds:[],_isCacheToBufferOn:!1,_cacheToBufferCmds:[],rendering:function(a){var b=this._renderCmds,c,d=a||cc._renderContext;a=0;for(c=b.length;a<c;a++)b[a].rendering(d)},_renderingToBuffer:function(a){var b=this._cacheToBufferCmds,c,d;a=a||cc._renderContext;c=0;for(d=b.length;c<d;c++)b[c].rendering(a);b.length=0;this._isCacheToBufferOn=!1},resetFlag:function(){this.childrenOrderDirty=!1;this._transformNodePool.length=
0},transform:function(){var a=this._transformNodePool;a.sort(this._sortNodeByLevelAsc);for(var b=0,c=a.length;b<c;b++)a[b]._renderCmdDiry&&a[b]._transformForRenderer();a.length=0},transformDirty:function(){return 0<this._transformNodePool.length},_sortNodeByLevelAsc:function(a,b){return a._curLevel-b._curLevel},pushDirtyNode:function(a){this._transformNodePool.push(a)},clearRenderCommands:function(){this._renderCmds.length=0},pushRenderCommand:function(a){this._isCacheToBufferOn?-1===this._cacheToBufferCmds.indexOf(a)&&
this._cacheToBufferCmds.push(a):-1===this._renderCmds.indexOf(a)&&this._renderCmds.push(a)}},cc.renderer=cc.rendererWebGL,cc.TextureRenderCmdWebGL=function(a){this._node=a},cc.TextureRenderCmdWebGL.prototype.rendering=function(a){var b=this._node;if(b._textureLoaded){a=a||cc._renderContext;var c=b._texture;c?c._isLoaded&&(b._shaderProgram.use(),b._shaderProgram._setUniformForMVPMatrixWithMat4(b._stackMatrix),cc.glBlendFunc(b._blendFunc.src,b._blendFunc.dst),cc.glBindTexture2DN(0,c),cc.glEnableVertexAttribs(cc.VERTEX_ATTRIB_FLAG_POS_COLOR_TEX),
...
function(a){this._node=a},cc.DrawNodeRenderCmdWebGL.prototype.rendering=function(a){a=this._node;cc.glBlendFunc(a._blendFunc.src,a._blendFunc.dst);a._shaderProgram.use();a._shaderProgram._setUniformForMVPMatrixWithMat4(a._stackMatrix);a._render()},cc.MontionStreakCmdWebGL=function(a){this._node=a},cc.MontionStreakCmdWebGL.prototype.rendering=function(a){var b=this._node;1>=b._nuPoints||!b.texture||!b.texture.isLoaded()||(a=a||cc._renderContext,b._shaderProgram.use(),b._shaderProgram._setUniformForMVPMatrixWithMat4(b._stackMatrix),
...
d[a].visit()}else this._rendererCmd&&cc.renderer.pushRenderCommand(this._rendererCmd);this.arrivalOrder=0;c.top=c.stack.pop()}};a._transformForRenderer=function(a){var c=this._transform4x4,d=this._stackMatrix;a=a||(this._parent?this._parent._stackMatrix:cc.current_stack.top);var e=this.nodeToParentTransform(),f=c.mat;f[0]=e.a;f[4]=e.c;f[12]=e.tx;f[1]=e.b;f[5]=e.d;f[13]=e.ty;f[14]=this._vertexZ;cc.kmMat4Multiply(d,a,c);null==this._camera||null!=this.grid&&this.grid.isActive()||(c=this._anchorPointInPoints.x,
a=this._anchorPointInPoints.y,0!==c||0!==a?(cc.SPRITEBATCHNODE_RENDER_SUBPIXEL||(c|=0,a|=0),e=new cc.kmMat4,cc.kmMat4Translation(e,c,a,0),cc.kmMat4Multiply(d,d,e),this._camera._locateForRenderer(d),cc.kmMat4Translation(e,-c,-a,0),cc.kmMat4Multiply(d,d,e)):this._camera.locate());this._renderCmdDiry=!1;if(this._children&&0!==this._children.length)for(e=this._children,c=0,a=e.length;c<a;c++)e[c]._transformForRenderer(d)};a.transform=function(){var a=this._transform4x4,c=cc.current_stack.top,d=this.nodeToParentTransform(),
...
cc.Node=cc.Class.extend({_localZOrder:0,_globalZOrder:0,_vertexZ:0,_rotationX:0,_rotationY:0,_scaleX:1,_scaleY:1,_position:null,_skewX:0,_skewY:0,_children:null,_visible:!0,_anchorPoint:null,_anchorPointInPoints:null,_contentSize:null,_running:!1,_parent:null,_ignoreAnchorPointForPosition:!1,tag:cc.NODE_TAG_INVALID,userData:null,userObject:null,_transformDirty:!0,_inverseDirty:!0,_cacheDirty:!0,_cachedParent:null,_transformGLDirty:null,_transform:null,_transformWorld:null,_inverse:null,_reorderChildDirty:!1,
_shaderProgram:null,arrivalOrder:0,_actionManager:null,_scheduler:null,_eventDispatcher:null,_initializedNode:!1,_additionalTransformDirty:!1,_additionalTransform:null,_componentContainer:null,_isTransitionFinished:!1,_rotationRadiansX:0,_rotationRadiansY:0,_className:"Node",_showNode:!1,_name:"",_displayedOpacity:255,_realOpacity:255,_displayedColor:null,_realColor:null,_cascadeColorEnabled:!1,_cascadeOpacityEnabled:!1,_usingNormalizedPosition:!1,_hashOfName:0,_curLevel:-1,_rendererCmd:null,_renderCmdDirty:!1,
_initNode:function(){this._anchorPoint=cc.p(0,0);this._anchorPointInPoints=cc.p(0,0);this._contentSize=cc.size(0,0);this._position=cc.p(0,0);this._children=[];this._transform={a:1,b:0,c:0,d:1,tx:0,ty:0};this._transformWorld={a:1,b:0,c:0,d:1,tx:0,ty:0};var a=cc.director;this._actionManager=a.getActionManager();this._scheduler=a.getScheduler();this._initializedNode=!0;this._additionalTransform=cc.affineTransformMakeIdentity();cc.ComponentContainer&&(this._componentContainer=new cc.ComponentContainer(this));
this._realOpacity=this._displayedOpacity=255;this._displayedColor=cc.color(255,255,255,255);this._realColor=cc.color(255,255,255,255);this._cascadeOpacityEnabled=this._cascadeColorEnabled=!1},init:function(){!1===this._initializedNode&&this._initNode();return!0},_arrayMakeObjectsPerformSelector:function(a,b){if(a&&0!==a.length){var c,d=a.length,e;c=cc.Node._StateCallbackType;switch(b){case c.onEnter:for(c=0;c<d;c++)if(e=a[c])e.onEnter();break;case c.onExit:for(c=0;c<d;c++)if(e=a[c])e.onExit();break;
case c.onEnterTransitionDidFinish:for(c=0;c<d;c++)if(e=a[c])e.onEnterTransitionDidFinish();break;case c.cleanup:for(c=0;c<d;c++)(e=a[c])&&e.cleanup();break;case c.updateTransform:for(c=0;c<d;c++)(e=a[c])&&e.updateTransform();break;case c.onExitTransitionDidStart:for(c=0;c<d;c++)if(e=a[c])e.onExitTransitionDidStart();break;case c.sortAllChildren:for(c=0;c<d;c++)(e=a[c])&&e.sortAllChildren();break;default:cc.assert(0,cc._LogInfos.Node__arrayMakeObjectsPerformSelector)}}},setNodeDirty:null,attr:function(a){for(var b in a)this[b]=
a[b]},getSkewX:function(){return this._skewX},setSkewX:function(a){this._skewX=a;this.setNodeDirty()},getSkewY:function(){return this._skewY},setSkewY:function(a){this._skewY=a;this.setNodeDirty()},setLocalZOrder:function(a){this._localZOrder=a;this._parent&&this._parent.reorderChild(this,a);cc.eventManager._setDirtyForNode(this)},_setLocalZOrder:function(a){this._localZOrder=a},getLocalZOrder:function(){return this._localZOrder},getZOrder:function(){cc.log(cc._LogInfos.Node_getZOrder);return this.getLocalZOrder()},
setZOrder:function(a){cc.log(cc._LogInfos.Node_setZOrder);this.setLocalZOrder(a)},setGlobalZOrder:function(a){this._globalZOrder!=a&&(this._globalZOrder=a,cc.eventManager._setDirtyForNode(this))},getGlobalZOrder:function(){return this._globalZOrder},getVertexZ:function(){return this._vertexZ},setVertexZ:function(a){this._vertexZ=a},getRotation:function(){this._rotationX!==this._rotationY&&cc.log(cc._LogInfos.Node_getRotation);return this._rotationX},setRotation:function(a){this._rotationX=this._rotationY=
a;this._rotationRadiansX=0.017453292519943295*this._rotationX;this._rotationRadiansY=0.017453292519943295*this._rotationY;this.setNodeDirty()},getRotationX:function(){return this._rotationX},setRotationX:function(a){this._rotationX=a;this._rotationRadiansX=0.017453292519943295*this._rotationX;this.setNodeDirty()},getRotationY:function(){return this._rotationY},setRotationY:function(a){this._rotationY=a;this._rotationRadiansY=0.017453292519943295*this._rotationY;this.setNodeDirty()},getScale:function(){this._scaleX!==
this._scaleY&&cc.log(cc._LogInfos.Node_getScale);return this._scaleX},setScale:function(a,b){this._scaleX=a;this._scaleY=b||0===b?b:a;this.setNodeDirty()},getScaleX:function(){return this._scaleX},setScaleX:function(a){this._scaleX=a;this.setNodeDirty()},getScaleY:function(){return this._scaleY},setScaleY:function(a){this._scaleY=a;this.setNodeDirty()},setPosition:function(a,b){var c=this._position;void 0===b?(c.x=a.x,c.y=a.y):(c.x=a,c.y=b);this.setNodeDirty()},getPosition:function(){return cc.p(this._position)},
getPositionX:function(){return this._position.x},setPositionX:function(a){this._position.x=a;this.setNodeDirty()},getPositionY:function(){return this._position.y},setPositionY:function(a){this._position.y=a;this.setNodeDirty()},getChildrenCount:function(){return this._children.length},getChildren:function(){return this._children},isVisible:function(){return this._visible},setVisible:function(a){this._visible!=a&&((this._visible=a)&&this.setNodeDirty(),cc.renderer.childrenOrderDirty=!0)},getAnchorPoint:function(){return cc.p(this._anchorPoint)},
setAnchorPoint:function(a,b){var c=this._anchorPoint;if(void 0===b){if(a.x===c.x&&a.y===c.y)return;c.x=a.x;c.y=a.y}else{if(a===c.x&&b===c.y)return;c.x=a;c.y=b}var d=this._anchorPointInPoints,e=this._contentSize;d.x=e.width*c.x;d.y=e.height*c.y;this.setNodeDirty()},_getAnchor:function(){return this._anchorPoint},_setAnchor:function(a){var b=a.x;a=a.y;this._anchorPoint.x!==b&&(this._anchorPoint.x=b,this._anchorPointInPoints.x=this._contentSize.width*b);this._anchorPoint.y!==a&&(this._anchorPoint.y=
a,this._anchorPointInPoints.y=this._contentSize.height*a);this.setNodeDirty()},_getAnchorX:function(){return this._anchorPoint.x},_setAnchorX:function(a){this._anchorPoint.x!==a&&(this._anchorPoint.x=a,this._anchorPointInPoints.x=this._contentSize.width*a,this.setNodeDirty())},_getAnchorY:function(){return this._anchorPoint.y},_setAnchorY:function(a){this._anchorPoint.y!==a&&(this._anchorPoint.y=a,this._anchorPointInPoints.y=this._contentSize.height*a,this.setNodeDirty())},getAnchorPointInPoints:function(){return cc.p(this._anchorPointInPoints)},
_getWidth:function(){return this._contentSize.width},_setWidth:function(a){this._contentSize.width=a;this._anchorPointInPoints.x=a*this._anchorPoint.x;this.setNodeDirty()},_getHeight:function(){return this._contentSize.height},_setHeight:function(a){this._contentSize.height=a;this._anchorPointInPoints.y=a*this._anchorPoint.y;this.setNodeDirty()},getContentSize:function(){return cc.size(this._contentSize)},setContentSize:function(a,b){var c=this._contentSize;if(void 0===b){if(a.width===c.width&&a.height===
c.height)return;c.width=a.width;c.height=a.height}else{if(a===c.width&&b===c.height)return;c.width=a;c.height=b}var d=this._anchorPointInPoints,e=this._anchorPoint;d.x=c.width*e.x;d.y=c.height*e.y;this.setNodeDirty()},isRunning:function(){return this._running},getParent:function(){return this._parent},setParent:function(a){this._parent=a},isIgnoreAnchorPointForPosition:function(){return this._ignoreAnchorPointForPosition},ignoreAnchorPointForPosition:function(a){a!=this._ignoreAnchorPointForPosition&&
(this._ignoreAnchorPointForPosition=a,this.setNodeDirty())},getTag:function(){return this.tag},setTag:function(a){this.tag=a},setName:function(a){this._name=a},getName:function(){return this._name},getUserData:function(){return this.userData},setUserData:function(a){this.userData=a},getUserObject:function(){return this.userObject},setUserObject:function(a){this.userObject!=a&&(this.userObject=a)},getOrderOfArrival:function(){return this.arrivalOrder},setOrderOfArrival:function(a){this.arrivalOrder=
a},getActionManager:function(){this._actionManager||(this._actionManager=cc.director.getActionManager());return this._actionManager},setActionManager:function(a){this._actionManager!=a&&(this.stopAllActions(),this._actionManager=a)},getScheduler:function(){this._scheduler||(this._scheduler=cc.director.getScheduler());return this._scheduler},setScheduler:function(a){this._scheduler!=a&&(this.unscheduleAllCallbacks(),this._scheduler=a)},boundingBox:function(){cc.log(cc._LogInfos.Node_boundingBox);return this.getBoundingBox()},
getBoundingBox:function(){var a=cc.rect(0,0,this._contentSize.width,this._contentSize.height);return cc._rectApplyAffineTransformIn(a,this.getNodeToParentTransform())},cleanup:function(){this.stopAllActions();this.unscheduleAllCallbacks();cc.eventManager.removeListeners(this);this._arrayMakeObjectsPerformSelector(this._children,cc.Node._StateCallbackType.cleanup)},getChildByTag:function(a){var b=this._children;if(null!=b)for(var c=0;c<b.length;c++){var d=b[c];if(d&&d.tag==a)return d}return null},
getChildByName:function(a){if(!a)return cc.log("Invalid name"),null;for(var b=this._children,c=0,d=b.length;c<d;c++)if(b[c]._name==a)return b[c];return null},addChild:function(a,b,c){b=void 0===b?a._localZOrder:b;var d,e=!1;cc.isUndefined(c)?(c=void 0,d=a._name):cc.isString(c)?(d=c,c=void 0):cc.isNumber(c)&&(e=!0,d="");cc.assert(a,cc._LogInfos.Node_addChild_3);cc.assert(null===a._parent,"child already added. It can't be added again");this._addChildHelper(a,b,c,d,e)},_addChildHelper:function(a,b,c,
d,e){this._children||(this._children=[]);this._insertChild(a,b);e?a.setTag(c):a.setName(d);a.setParent(this);a.setOrderOfArrival(cc.s_globalOrderOfArrival++);if(this._running&&(a.onEnter(),this._isTransitionFinished))a.onEnterTransitionDidFinish();this._cascadeColorEnabled&&this._enableCascadeColor();this._cascadeOpacityEnabled&&this._enableCascadeOpacity()},removeFromParent:function(a){this._parent&&(null==a&&(a=!0),this._parent.removeChild(this,a))},removeFromParentAndCleanup:function(a){cc.log(cc._LogInfos.Node_removeFromParentAndCleanup);
this.removeFromParent(a)},removeChild:function(a,b){0!==this._children.length&&(null==b&&(b=!0),-1<this._children.indexOf(a)&&this._detachChild(a,b),this.setNodeDirty(),cc.renderer.childrenOrderDirty=!0)},removeChildByTag:function(a,b){a===cc.NODE_TAG_INVALID&&cc.log(cc._LogInfos.Node_removeChildByTag);var c=this.getChildByTag(a);null==c?cc.log(cc._LogInfos.Node_removeChildByTag_2,a):this.removeChild(c,b)},removeAllChildrenWithCleanup:function(a){this.removeAllChildren(a)},removeAllChildren:function(a){var b=
this._children;if(null!=b){null==a&&(a=!0);for(var c=0;c<b.length;c++){var d=b[c];d&&(this._running&&(d.onExitTransitionDidStart(),d.onExit()),a&&d.cleanup(),d.parent=null)}this._children.length=0}},_detachChild:function(a,b){this._running&&(a.onExitTransitionDidStart(),a.onExit());b&&a.cleanup();a.parent=null;a._cachedParent=null;cc.arrayRemoveObject(this._children,a)},_insertChild:function(a,b){cc.renderer.childrenOrderDirty=this._reorderChildDirty=!0;this._children.push(a);a._setLocalZOrder(b)},
...
this.getNodeToWorldTransform())},convertToNodeSpaceAR:function(a){return cc.pSub(this.convertToNodeSpace(a),this._anchorPointInPoints)},convertToWorldSpaceAR:function(a){a=a||cc.p(0,0);a=cc.pAdd(a,this._anchorPointInPoints);return this.convertToWorldSpace(a)},_convertToWindowSpace:function(a){a=this.convertToWorldSpace(a);return cc.director.convertToUI(a)},convertTouchToNodeSpace:function(a){a=a.getLocation();return this.convertToNodeSpace(a)},convertTouchToNodeSpaceAR:function(a){a=a.getLocation();
a=cc.director.convertToGL(a);return this.convertToNodeSpaceAR(a)},update:function(a){this._componentContainer&&!this._componentContainer.isEmpty()&&this._componentContainer.visit(a)},updateTransform:function(){this._arrayMakeObjectsPerformSelector(this._children,cc.Node._StateCallbackType.updateTransform)},retain:function(){},release:function(){},getComponent:function(a){return this._componentContainer?this._componentContainer.getComponent(a):null},addComponent:function(a){this._componentContainer&&
this._componentContainer.add(a)},removeComponent:function(a){return this._componentContainer?this._componentContainer.remove(a):!1},removeAllComponents:function(){this._componentContainer&&this._componentContainer.removeAll()},grid:null,ctor:null,visit:null,transform:null,nodeToParentTransform:function(){return this.getNodeToParentTransform()},getNodeToParentTransform:null,_setNodeDirtyForCache:function(){if(!1===this._cacheDirty){this._cacheDirty=!0;var a=this._cachedParent;a&&a!=this&&a._setNodeDirtyForCache()}},
_setCachedParent:function(a){if(this._cachedParent!=a){this._cachedParent=a;for(var b=this._children,c=0,d=b.length;c<d;c++)b[c]._setCachedParent(a)}},getCamera:function(){this._camera||(this._camera=new cc.Camera);return this._camera},getGrid:function(){return this.grid},setGrid:function(a){this.grid=a},getShaderProgram:function(){return this._shaderProgram},setShaderProgram:function(a){this._shaderProgram=a},getGLServerState:function(){return this._glServerState},setGLServerState:function(a){this._glServerState=
...
cc.affineTransformConcat(this.getNodeToParentTransform(),a);b=cc.rectApplyAffineTransform(b,a);if(!this._children)return b;for(var c=this._children,d=0;d<c.length;d++){var e=c[d];e&&e._visible&&(e=e._getBoundingBoxToCurrentNode(a))&&(b=cc.rectUnion(b,e))}return b},_getNodeToParentTransformForWebGL:function(){if(this._transformDirty){var a=this._position.x,b=this._position.y,c=this._anchorPointInPoints.x,d=-c,e=this._anchorPointInPoints.y,f=-e,g=this._scaleX,h=this._scaleY;this._ignoreAnchorPointForPosition&&
(a+=c,b+=e);var k=1,m=0,n=1,q=0;if(0!==this._rotationX||0!==this._rotationY)k=Math.cos(-this._rotationRadiansX),m=Math.sin(-this._rotationRadiansX),n=Math.cos(-this._rotationRadiansY),q=Math.sin(-this._rotationRadiansY);var r=this._skewX||this._skewY;r||0===c&&0===e||(a+=n*d*g+-m*f*h,b+=q*d*g+k*f*h);var s=this._transform;s.a=n*g;s.b=q*g;s.c=-m*h;s.d=k*h;s.tx=a;s.ty=b;r&&(s=cc.affineTransformConcat({a:1,b:Math.tan(cc.degreesToRadians(this._skewY)),c:Math.tan(cc.degreesToRadians(this._skewX)),d:1,tx:0,
ty:0},s),0!==c||0!==e)&&(s=cc.affineTransformTranslate(s,d,f));this._additionalTransformDirty&&(s=cc.affineTransformConcat(s,this._additionalTransform),this._additionalTransformDirty=!1);this._transform=s;this._transformDirty=!1}return this._transform},_updateColor:function(){},getOpacity:function(){return this._realOpacity},getDisplayedOpacity:function(){return this._displayedOpacity},setOpacity:function(a){this._displayedOpacity=this._realOpacity=a;var b=255,c=this._parent;c&&c.cascadeOpacity&&
(b=c.getDisplayedOpacity());this.updateDisplayedOpacity(b);this._displayedColor.a=this._realColor.a=a},updateDisplayedOpacity:function(a){this._displayedOpacity=this._realOpacity*a/255;this._rendererCmd&&void 0!==this._rendererCmd._opacity&&(this._rendererCmd._opacity=this._displayedOpacity/255);if(this._cascadeOpacityEnabled){a=this._children;for(var b=0;b<a.length;b++){var c=a[b];c&&c.updateDisplayedOpacity(this._displayedOpacity)}}},isCascadeOpacityEnabled:function(){return this._cascadeOpacityEnabled},
...
b[a],0>c._localZOrder)c.visit();else break;for(this._rendererCmd&&cc.renderer.pushRenderCommand(this._rendererCmd);a<d;a++)b[a].visit()}else this._rendererCmd&&cc.renderer.pushRenderCommand(this._rendererCmd);this.arrivalOrder=0}},_p._transformForRenderer=function(){var a=this.nodeToParentTransform(),b=this._transformWorld;if(this._parent){var c=this._parent._transformWorld;b.a=a.a*c.a+a.b*c.c;b.b=a.a*c.b+a.b*c.d;b.c=a.c*c.a+a.d*c.c;b.d=a.c*c.b+a.d*c.d;if(!this._skewX||this._skewY){var d=this._parent._transform,
e=-(d.b+d.c)*a.tx;b.tx=a.tx*c.a+a.ty*c.c+c.tx+-(d.b+d.c)*a.ty;b.ty=a.tx*c.b+a.ty*c.d+c.ty+e}else b.tx=a.tx*c.a+a.ty*c.c+c.tx,b.ty=a.tx*c.b+a.ty*c.d+c.ty}else b.a=a.a,b.b=a.b,b.c=a.c,b.d=a.d,b.tx=a.tx,b.ty=a.ty;this._renderCmdDiry=!1;if(this._children&&0!==this._children.length)for(c=this._children,a=0,b=c.length;a<b;a++)c[a]._transformForRenderer()},_p.transform=function(a){a=this.nodeToParentTransform();var b=this._transformWorld;if(this._parent){var c=this._parent._transformWorld;b.a=a.a*c.a+a.b*
c.c;b.b=a.a*c.b+a.b*c.d;b.c=a.c*c.a+a.d*c.c;b.d=a.c*c.b+a.d*c.d;var d=this._parent._transform,e=-(d.b+d.c)*a.tx;b.tx=a.tx*c.a+a.ty*c.c+c.tx+-(d.b+d.c)*a.ty;b.ty=a.tx*c.b+a.ty*c.d+c.ty+e}else b.a=a.a,b.b=a.b,b.c=a.c,b.d=a.d,b.tx=a.tx,b.ty=a.ty},_p.getNodeToParentTransform=function(){if(this._transformDirty){var a=this._transform;a.tx=this._position.x;a.ty=this._position.y;var b=1,c=0;this._rotationX&&(b=Math.cos(this._rotationRadiansX),c=Math.sin(this._rotationRadiansX));a.a=a.d=b;a.b=-c;a.c=c;var d=
this._scaleX,e=this._scaleY,f=this._anchorPointInPoints.x,g=this._anchorPointInPoints.y,h=1E-6>d&&-1E-6<d?1E-6:d,k=1E-6>e&&-1E-6<e?1E-6:e;if(this._skewX||this._skewY){var m=Math.tan(-this._skewX*Math.PI/180),n=Math.tan(-this._skewY*Math.PI/180);Infinity===m&&(m=99999999);Infinity===n&&(n=99999999);var q=g*m*h,r=f*n*k;a.a=b+-c*n;a.b=b*m+-c;a.c=c+b*n;a.d=c*m+b;a.tx+=b*q+-c*r;a.ty+=c*q+b*r}if(1!==d||1!==e)a.a*=h,a.c*=h,a.b*=k,a.d*=k;this._flippedX||(a.tx+=b*-f*h+-c*g*k);this._flippedY||(a.ty-=c*-f*h+
b*g*k);this._ignoreAnchorPointForPosition&&(a.tx+=f,a.ty+=g);this._additionalTransformDirty&&(this._transform=cc.affineTransformConcat(a,this._additionalTransform),this._additionalTransformDirty=!1);this._transformDirty=!1}return this._transform},_p=null):(cc.assert(cc.isFunction(cc._tmp.WebGLCCNode),cc._LogInfos.MissingFile,"BaseNodesWebGL.js"),cc._tmp.WebGLCCNode(),delete cc._tmp.WebGLCCNode);cc.assert(cc.isFunction(cc._tmp.PrototypeCCNode),cc._LogInfos.MissingFile,"BaseNodesPropertyDefine.js");
cc._tmp.PrototypeCCNode();delete cc._tmp.PrototypeCCNode;cc.AtlasNode=cc.Node.extend({textureAtlas:null,quadsToDraw:0,_itemsPerRow:0,_itemsPerColumn:0,_itemWidth:0,_itemHeight:0,_colorUnmodified:null,_opacityModifyRGB:!1,_blendFunc:null,_ignoreContentScaleFactor:!1,_className:"AtlasNode",ctor:function(a,b,c,d){cc.Node.prototype.ctor.call(this);this._colorUnmodified=cc.color.WHITE;this._blendFunc={src:cc.BLEND_SRC,dst:cc.BLEND_DST};this._ignoreContentScaleFactor=!1;void 0!==d&&this.initWithTileFile(a,b,c,d)},_initRendererCmd:function(){cc._renderType===
...
if(a&&a._color){var b=this._displayedColor;a._color.r=b.r;a._color.g=b.g;a._color.b=b.b;a._color.a=this._displayedOpacity/255}},_p.draw=function(a){a=a||cc._renderContext;var b=cc.view,c=this._displayedColor;a.fillStyle="rgba("+(0|c.r)+","+(0|c.g)+","+(0|c.b)+","+this._displayedOpacity/255+")";a.fillRect(0,0,this.width*b.getScaleX(),-this.height*b.getScaleY());cc.g_NumberOfDraws++},_p.visit=function(a){if(this._isBaked){a=a||cc._renderContext;var b,c=this._children,d=c.length;if(this._visible){var e=
this._bakeSprite;a.save();this.transform(a);if(this._cacheDirty){b=this._getBoundingBoxForBake();b.width|=0;b.height|=0;var f=e.getCacheContext();e.resetCanvasSize(b.width,b.height);var g=e.getAnchorPointInPoints(),h=this._position;if(this._ignoreAnchorPointForPosition)f.translate(0-b.x+h.x,b.height+b.y-h.y),e.setPosition(g.x+b.x-h.x,g.y+b.y-h.y);else{var k=this.getAnchorPointInPoints(),m=h.x-k.x,h=h.y-k.y;f.translate(0-b.x+m,b.height+b.y-h);e.setPosition(g.x+b.x-m,g.y+b.y-h)}cc.view._setScaleXYForRenderTexture();
if(0<d){this.sortAllChildren();for(b=0;b<d;b++)if(g=c[b],0>g._localZOrder)g.visit(f);else break;for(this._rendererCmd&&cc.renderer.pushRenderCommand(this._rendererCmd);b<d;b++)c[b].visit(f)}else this._rendererCmd&&cc.renderer.pushRenderCommand(this._rendererCmd);cc.view._resetScale();this._cacheDirty=!1}e.visit(a);this.arrivalOrder=0;a.restore()}}else cc.Node.prototype.visit.call(this,a)},_p._getBoundingBoxForBake=function(){var a=cc.rect(0,0,this._contentSize.width,this._contentSize.height),b=this.nodeToWorldTransform(),
a=cc.rectApplyAffineTransform(a,this.nodeToWorldTransform());if(!this._children||0===this._children.length)return a;for(var c=this._children,d=0;d<c.length;d++){var e=c[d];e&&e._visible&&(e=e._getBoundingBoxToCurrentNode(b),a=cc.rectUnion(a,e))}return a},_p=null):(cc.assert(cc.isFunction(cc._tmp.WebGLLayerColor),cc._LogInfos.MissingFile,"CCLayerWebGL.js"),cc._tmp.WebGLLayerColor(),delete cc._tmp.WebGLLayerColor);cc.assert(cc.isFunction(cc._tmp.PrototypeLayerColor),cc._LogInfos.MissingFile,"CCLayerPropertyDefine.js");
cc._tmp.PrototypeLayerColor();delete cc._tmp.PrototypeLayerColor;
cc.LayerGradient=cc.LayerColor.extend({_startColor:null,_endColor:null,_startOpacity:255,_endOpacity:255,_alongVector:null,_compressedInterpolation:!1,_className:"LayerGradient",ctor:function(a,b,c){cc.LayerColor.prototype.ctor.call(this);this._startColor=cc.color(0,0,0,255);this._endColor=cc.color(0,0,0,255);this._alongVector=cc.p(0,-1);this._endOpacity=this._startOpacity=255;cc.LayerGradient.prototype.init.call(this,a,b,c)},_initRendererCmd:function(){this._rendererCmd=new cc.GradientRectRenderCmdCanvas(this)},
init:function(a,b,c){a=a||cc.color(0,0,0,255);b=b||cc.color(0,0,0,255);c=c||cc.p(0,-1);var d=this._startColor,e=this._endColor;d.r=a.r;d.g=a.g;d.b=a.b;this._startOpacity=a.a;e.r=b.r;e.g=b.g;e.b=b.b;this._endOpacity=b.a;this._alongVector=c;this._compressedInterpolation=!0;cc.LayerColor.prototype.init.call(this,cc.color(a.r,a.g,a.b,255));cc.LayerGradient.prototype._updateColor.call(this);return!0},setContentSize:function(a,b){cc.LayerColor.prototype.setContentSize.call(this,a,b);this._updateColor()},
_setWidth:function(a){cc.LayerColor.prototype._setWidth.call(this,a);this._updateColor()},_setHeight:function(a){cc.LayerColor.prototype._setHeight.call(this,a);this._updateColor()},getStartColor:function(){return this._realColor},setStartColor:function(a){this.color=a},setEndColor:function(a){this._endColor=a;this._updateColor()},getEndColor:function(){return this._endColor},setStartOpacity:function(a){this._startOpacity=a;this._updateColor()},getStartOpacity:function(){return this._startOpacity},
setEndOpacity:function(a){this._endOpacity=a;this._updateColor()},getEndOpacity:function(){return this._endOpacity},setVector:function(a){this._alongVector.x=a.x;this._alongVector.y=a.y;this._updateColor()},getVector:function(){return cc.p(this._alongVector.x,this._alongVector.y)},isCompressedInterpolation:function(){return this._compressedInterpolation},setCompressedInterpolation:function(a){this._compressedInterpolation=a;this._updateColor()},_draw:null,_updateColor:null});
cc.LayerGradient.create=function(a,b,c){return new cc.LayerGradient(a,b,c)};cc._renderType===cc._RENDER_TYPE_CANVAS?(_p=cc.LayerGradient.prototype,_p._updateColor=function(){var a=this._alongVector,b=0.5*this.width,c=0.5*this.height,d=this._rendererCmd;d._startPoint.x=b*-a.x+b;d._startPoint.y=c*a.y-c;d._endPoint.x=b*a.x+b;d._endPoint.y=c*-a.y-c},_p=null):(cc.assert(cc.isFunction(cc._tmp.WebGLLayerGradient),cc._LogInfos.MissingFile,"CCLayerWebGL.js"),cc._tmp.WebGLLayerGradient(),delete cc._tmp.WebGLLayerGradient);
cc.assert(cc.isFunction(cc._tmp.PrototypeLayerGradient),cc._LogInfos.MissingFile,"CCLayerPropertyDefine.js");cc._tmp.PrototypeLayerGradient();delete cc._tmp.PrototypeLayerGradient;
...
c)};a.init=function(){if(0<arguments.length)return this.initWithFile(arguments[0],arguments[1]);cc.Node.prototype.init.call(this);this.dirty=this._recursiveDirty=!1;this._opacityModifyRGB=!0;this._blendFunc.src=cc.BLEND_SRC;this._blendFunc.dst=cc.BLEND_DST;this.texture=null;this._textureLoaded=!0;this._flippedX=this._flippedY=!1;this.anchorY=this.anchorX=0.5;this._offsetPosition.x=0;this._offsetPosition.y=0;this._hasChildren=!1;var a={r:255,g:255,b:255,a:255};this._quad.bl.colors=a;this._quad.br.colors=
a;this._quad.tl.colors=a;this._quad.tr.colors=a;this._quadDirty=!0;this.setTextureRect(cc.rect(0,0,0,0),!1,cc.size(0,0));return!0};a.initWithTexture=function(a,c,d){cc.assert(0!=arguments.length,cc._LogInfos.Sprite_initWithTexture);d=d||!1;if(!cc.Node.prototype.init.call(this))return!1;this._batchNode=null;this.dirty=this._recursiveDirty=!1;this._opacityModifyRGB=!0;this._blendFunc.src=cc.BLEND_SRC;this._blendFunc.dst=cc.BLEND_DST;this._flippedX=this._flippedY=!1;this.anchorY=this.anchorX=0.5;this._offsetPosition.x=
0;this._offsetPosition.y=0;this._hasChildren=!1;var e=cc.color(255,255,255,255),f=this._quad;f.bl.colors=e;f.br.colors=e;f.tl.colors=e;f.tr.colors=e;this._textureLoaded=e=a.isLoaded();if(!e)return this._rectRotated=d||!1,c&&(e=this._rect,e.x=c.x,e.y=c.y,e.width=c.width,e.height=c.height),a.addLoadedEventListener(this._textureLoadedCallback,this),!0;c||(c=cc.rect(0,0,a.width,a.height));a&&a.url&&(d?(e=c.x+c.height,f=c.y+c.width):(e=c.x+c.width,f=c.y+c.height),e>a.width&&cc.error(cc._LogInfos.RectWidth,
a.url),f>a.height&&cc.error(cc._LogInfos.RectHeight,a.url));this.texture=a;this.setTextureRect(c,d);this.batchNode=null;return this._quadDirty=!0};a._textureLoadedCallback=function(a){if(!this._textureLoaded){this._textureLoaded=!0;var c=this._rect;c?cc._rectEqualToZero(c)&&(c.width=a.width,c.height=a.height):c=cc.rect(0,0,a.width,a.height);this.texture=a;this.setTextureRect(c,this._rectRotated);this.batchNode=this._batchNode;this._quadDirty=!0;this._callLoadedEventCallbacks()}};a.setTextureRect=
function(a,c,d){this._rectRotated=c||!1;this.setContentSize(d||a);this.setVertexRect(a);this._setTextureCoords(a);a=this._unflippedOffsetPositionFromCenter;this._flippedX&&(a.x=-a.x);this._flippedY&&(a.y=-a.y);var e=this._rect;this._offsetPosition.x=a.x+(this._contentSize.width-e.width)/2;this._offsetPosition.y=a.y+(this._contentSize.height-e.height)/2;if(this._batchNode)this.dirty=!0;else{a=this._offsetPosition.x;c=this._offsetPosition.y;d=a+e.width;var e=c+e.height,f=this._quad;f.bl.vertices={x:a,
y:c,z:0};f.br.vertices={x:d,y:c,z:0};f.tl.vertices={x:a,y:e,z:0};f.tr.vertices={x:d,y:e,z:0};this._quadDirty=!0}};a.updateTransform=function(){if(this.dirty){var a=this._quad,c=this._parent;if(!this._visible||c&&c!=this._batchNode&&c._shouldBeHidden)a.br.vertices=a.tl.vertices=a.tr.vertices=a.bl.vertices={x:0,y:0,z:0},this._shouldBeHidden=!0;else{this._shouldBeHidden=!1;var d=this._transformToBatch=c&&c!=this._batchNode?cc.affineTransformConcat(this.nodeToParentTransform(),c._transformToBatch):this.nodeToParentTransform(),
e=this._rect,c=this._offsetPosition.x,f=this._offsetPosition.y,g=c+e.width,h=f+e.height,k=d.tx,m=d.ty,n=d.a,q=d.b,r=d.d,s=-d.c,d=c*n-f*s+k,e=c*q+f*r+m,t=g*n-f*s+k,f=g*q+f*r+m,u=g*n-h*s+k,g=g*q+h*r+m,k=c*n-h*s+k,c=c*q+h*r+m,h=this._vertexZ;cc.SPRITEBATCHNODE_RENDER_SUBPIXEL||(d|=0,e|=0,t|=0,f|=0,u|=0,g|=0,k|=0,c|=0);a.bl.vertices={x:d,y:e,z:h};a.br.vertices={x:t,y:f,z:h};a.tl.vertices={x:k,y:c,z:h};a.tr.vertices={x:u,y:g,z:h}}this.textureAtlas.updateQuad(a,this.atlasIndex);this.dirty=this._recursiveDirty=
...
!0;var b=a.getTexture();b!=c._texture&&(c.texture=b);c.setTextureRect(a.getRect(),a.isRotated(),a.getOriginalSize());c._callLoadedEventCallbacks()},c));d!=c._texture&&(c.texture=d);c._rectRotated=a.isRotated();c.setTextureRect(a.getRect(),c._rectRotated,a.getOriginalSize())};a.isFrameDisplayed=function(a){return cc.rectEqualToRect(a.getRect(),this._rect)&&a.getTexture().getName()==this._texture.getName()&&cc.pointEqualToPoint(a.getOffset(),this._unflippedOffsetPositionFromCenter)};a.setBatchNode=
function(a){if(this._batchNode=a)this._transformToBatch=cc.affineTransformIdentity(),this.textureAtlas=this._batchNode.textureAtlas;else{this.atlasIndex=cc.Sprite.INDEX_NOT_INITIALIZED;this.textureAtlas=null;this.dirty=this._recursiveDirty=!1;a=this._offsetPosition.x;var c=this._offsetPosition.y,d=a+this._rect.width,e=c+this._rect.height,f=this._quad;f.bl.vertices={x:a,y:c,z:0};f.br.vertices={x:d,y:c,z:0};f.tl.vertices={x:a,y:e,z:0};f.tr.vertices={x:d,y:e,z:0};this._quadDirty=!0}};a.setTexture=function(a){var c=
this;if(a&&cc.isString(a)){a=cc.textureCache.addImage(a);c.setTexture(a);var d=a.getContentSize();c.setTextureRect(cc.rect(0,0,d.width,d.height));a._isLoaded||a.addLoadedEventListener(function(){var d=a.getContentSize();c.setTextureRect(cc.rect(0,0,d.width,d.height))},this)}else cc.assert(!a||a instanceof cc.Texture2D,cc._LogInfos.Sprite_setTexture_2),c._batchNode&&c._batchNode.texture!=a?cc.log(cc._LogInfos.Sprite_setTexture):(c.shaderProgram=a?cc.shaderCache.programForKey(cc.SHADER_POSITION_TEXTURECOLOR):
cc.shaderCache.programForKey(cc.SHADER_POSITION_COLOR),c._batchNode||c._texture==a||(c._texture=a,c._updateBlendFunc()))};a.draw=function(){if(this._textureLoaded){var a=cc._renderContext,c=this._texture;c?c._isLoaded&&(this._shaderProgram.use(),this._shaderProgram.setUniformForModelViewAndProjectionMatrixWithMat4(),cc.glBlendFunc(this._blendFunc.src,this._blendFunc.dst),cc.glBindTexture2DN(0,c),cc.glEnableVertexAttribs(cc.VERTEX_ATTRIB_FLAG_POS_COLOR_TEX),a.bindBuffer(a.ARRAY_BUFFER,this._quadWebBuffer),
this._quadDirty&&(a.bufferData(a.ARRAY_BUFFER,this._quad.arrayBuffer,a.DYNAMIC_DRAW),this._quadDirty=!1),a.vertexAttribPointer(0,3,a.FLOAT,!1,24,0),a.vertexAttribPointer(1,4,a.UNSIGNED_BYTE,!0,24,12),a.vertexAttribPointer(2,2,a.FLOAT,!1,24,16),a.drawArrays(a.TRIANGLE_STRIP,0,4)):(this._shaderProgram.use(),this._shaderProgram.setUniformForModelViewAndProjectionMatrixWithMat4(),cc.glBlendFunc(this._blendFunc.src,this._blendFunc.dst),cc.glBindTexture2D(null),cc.glEnableVertexAttribs(cc.VERTEX_ATTRIB_FLAG_POSITION|
cc.VERTEX_ATTRIB_FLAG_COLOR),a.bindBuffer(a.ARRAY_BUFFER,this._quadWebBuffer),this._quadDirty&&(cc._renderContext.bufferData(cc._renderContext.ARRAY_BUFFER,this._quad.arrayBuffer,cc._renderContext.STATIC_DRAW),this._quadDirty=!1),a.vertexAttribPointer(cc.VERTEX_ATTRIB_POSITION,3,a.FLOAT,!1,24,0),a.vertexAttribPointer(cc.VERTEX_ATTRIB_COLOR,4,a.UNSIGNED_BYTE,!0,24,12),a.drawArrays(a.TRIANGLE_STRIP,0,4));cc.g_NumberOfDraws++;if(0!==cc.SPRITE_DEBUG_DRAW||this._showNode)1===cc.SPRITE_DEBUG_DRAW||this._showNode?
(a=this._quad,a=[cc.p(a.tl.vertices.x,a.tl.vertices.y),cc.p(a.bl.vertices.x,a.bl.vertices.y),cc.p(a.br.vertices.x,a.br.vertices.y),cc.p(a.tr.vertices.x,a.tr.vertices.y)],cc._drawingUtil.drawPoly(a,4,!0)):2===cc.SPRITE_DEBUG_DRAW&&(a=this.getTextureRect(),c=this.getOffsetPosition(),a=[cc.p(c.x,c.y),cc.p(c.x+a.width,c.y),cc.p(c.x+a.width,c.y+a.height),cc.p(c.x,c.y+a.height)],cc._drawingUtil.drawPoly(a,4,!0))}};delete a};cc._tmp.PrototypeSprite=function(){var a=cc.Sprite.prototype;cc.defineGetterSetter(a,"opacityModifyRGB",a.isOpacityModifyRGB,a.setOpacityModifyRGB);cc.defineGetterSetter(a,"opacity",a.getOpacity,a.setOpacity);cc.defineGetterSetter(a,"color",a.getColor,a.setColor);cc.defineGetterSetter(a,"flippedX",a.isFlippedX,a.setFlippedX);cc.defineGetterSetter(a,"flippedY",a.isFlippedY,a.setFlippedY);cc.defineGetterSetter(a,"offsetX",a._getOffsetX);cc.defineGetterSetter(a,"offsetY",a._getOffsetY);cc.defineGetterSetter(a,
...
cc.log(cc._LogInfos.Sprite_setDisplayFrameWithAnimationName_2):cc.log(cc._LogInfos.Sprite_setDisplayFrameWithAnimationName)},getBatchNode:function(){return this._batchNode},_setReorderChildDirtyRecursively:function(){if(!this._reorderChildDirty){this._reorderChildDirty=!0;for(var a=this._parent;a&&a!=this._batchNode;)a._setReorderChildDirtyRecursively(),a=a.parent}},getTexture:function(){return this._texture},_quad:null,_quadWebBuffer:null,_quadDirty:!1,_colorized:!1,_blendFuncStr:"source",_originalTexture:null,
_drawSize_Canvas:null,ctor:null,_softInit:function(a,b,c){if(void 0===a)cc.Sprite.prototype.init.call(this);else if(cc.isString(a))"#"===a[0]?(a=a.substr(1,a.length-1),a=cc.spriteFrameCache.getSpriteFrame(a),this.initWithSpriteFrame(a)):cc.Sprite.prototype.init.call(this,a,b);else if(cc.isObject(a))if(a instanceof cc.Texture2D)this.initWithTexture(a,b,c);else if(a instanceof cc.SpriteFrame)this.initWithSpriteFrame(a);else if(a instanceof HTMLImageElement||a instanceof HTMLCanvasElement)b=new cc.Texture2D,
...
a);this._setNodeDirtyForCache()},_p.ctor=function(a,b,c){cc.Node.prototype.ctor.call(this);this._shouldBeHidden=!1;this._offsetPosition=cc.p(0,0);this._unflippedOffsetPositionFromCenter=cc.p(0,0);this._blendFunc={src:cc.BLEND_SRC,dst:cc.BLEND_DST};this._rect=cc.rect(0,0,0,0);this._newTextureWhenChangeColor=!1;this._textureLoaded=!0;this._drawSize_Canvas=cc.size(0,0);this._softInit(a,b,c)},_p._initRendererCmd=function(){this._rendererCmd=new cc.TextureRenderCmdCanvas(this)},_p.setBlendFunc=function(a,
b){var c=this._blendFunc;void 0===b?(c.src=a.src,c.dst=a.dst):(c.src=a,c.dst=b);cc._renderType===cc._RENDER_TYPE_CANVAS&&(this._blendFuncStr=cc._getCompositeOperationByBlendFunc(c))},_p.init=function(){if(0<arguments.length)return this.initWithFile(arguments[0],arguments[1]);cc.Node.prototype.init.call(this);this.dirty=this._recursiveDirty=!1;this._opacityModifyRGB=!0;this._blendFunc.src=cc.BLEND_SRC;this._blendFunc.dst=cc.BLEND_DST;this.texture=null;this._textureLoaded=!0;this._flippedX=this._flippedY=
!1;this.anchorY=this.anchorX=0.5;this._offsetPosition.x=0;this._offsetPosition.y=0;this._hasChildren=!1;this.setTextureRect(cc.rect(0,0,0,0),!1,cc.size(0,0));return!0},_p.initWithTexture=function(a,b,c){cc.assert(0!=arguments.length,cc._LogInfos.CCSpriteBatchNode_initWithTexture);if((c=c||!1)&&a.isLoaded()){var d=a.getHtmlElementObj(),d=cc.cutRotateImageToCanvas(d,b),e=new cc.Texture2D;e.initWithElement(d);e.handleLoadedTexture();a=e;this._rect=cc.rect(0,0,b.width,b.height)}if(!cc.Node.prototype.init.call(this))return!1;
this._batchNode=null;this.dirty=this._recursiveDirty=!1;this._opacityModifyRGB=!0;this._blendFunc.src=cc.BLEND_SRC;this._blendFunc.dst=cc.BLEND_DST;this._flippedX=this._flippedY=!1;this.anchorY=this.anchorX=0.5;this._offsetPosition.x=0;this._offsetPosition.y=0;this._hasChildren=!1;this._textureLoaded=d=a.isLoaded();if(!d)return this._rectRotated=c,b&&(this._rect.x=b.x,this._rect.y=b.y,this._rect.width=b.width,this._rect.height=b.height),this.texture&&this.texture.removeLoadedEventListener(this),a.addLoadedEventListener(this._textureLoadedCallback,
...
this._originalTexture=a;this.setTextureRect(b,this._rectRotated);a=this._displayedColor;255==a.r&&255==a.g&&255==a.b||this._changeTextureColor();this.batchNode=this._batchNode;this._callLoadedEventCallbacks()}},_p.setTextureRect=function(a,b,c){this._rectRotated=b||!1;this.setContentSize(c||a);this.setVertexRect(a);b=this._rendererCmd._textureCoord;c=cc.contentScaleFactor();b.renderX=b.x=0|a.x*c;b.renderY=b.y=0|a.y*c;b.width=0|a.width*c;b.height=0|a.height*c;b.validRect=!(0===b.width||0===b.height||
0>b.x||0>b.y);a=this._unflippedOffsetPositionFromCenter;this._flippedX&&(a.x=-a.x);this._flippedY&&(a.y=-a.y);this._offsetPosition.x=a.x+(this._contentSize.width-this._rect.width)/2;this._offsetPosition.y=a.y+(this._contentSize.height-this._rect.height)/2;this._batchNode&&(this.dirty=!0)},_p.updateTransform=function(){if(this.dirty){var a=this._parent;!this._visible||a&&a!=this._batchNode&&a._shouldBeHidden?this._shouldBeHidden=!0:(this._shouldBeHidden=!1,this._transformToBatch=a&&a!=this._batchNode?
cc.affineTransformConcat(this.nodeToParentTransform(),a._transformToBatch):this.nodeToParentTransform());this.dirty=this._recursiveDirty=!1}this._hasChildren&&this._arrayMakeObjectsPerformSelector(this._children,cc.Node._StateCallbackType.updateTransform)},_p.addChild=function(a,b,c){cc.assert(a,cc._LogInfos.CCSpriteBatchNode_addChild_2);null==b&&(b=a._localZOrder);null==c&&(c=a.tag);cc.Node.prototype.addChild.call(this,a,b,c);this._hasChildren=!0},_p.setOpacity=function(a){cc.Node.prototype.setOpacity.call(this,
...
cc.affineTransformIdentity(),this.textureAtlas=this._batchNode.textureAtlas):(this.atlasIndex=cc.Sprite.INDEX_NOT_INITIALIZED,this.textureAtlas=null,this.dirty=this._recursiveDirty=!1)},_p.setTexture=function(a){var b=this;if(a&&cc.isString(a)){a=cc.textureCache.addImage(a);b.setTexture(a);var c=a.getContentSize();b.setTextureRect(cc.rect(0,0,c.width,c.height));a._isLoaded||a.addLoadedEventListener(function(){var c=a.getContentSize();b.setTextureRect(cc.rect(0,0,c.width,c.height))},this)}else cc.assert(!a||
...
a.y,a.width,a.height)},setRectInPixels:function(a){this._rectInPixels||(this._rectInPixels=cc.rect(0,0,0,0));this._rectInPixels.x=a.x;this._rectInPixels.y=a.y;this._rectInPixels.width=a.width;this._rectInPixels.height=a.height;this._rect=cc.rectPixelsToPoints(a)},isRotated:function(){return this._rotated},setRotated:function(a){this._rotated=a},getRect:function(){var a=this._rect;return cc.rect(a.x,a.y,a.width,a.height)},setRect:function(a){this._rect||(this._rect=cc.rect(0,0,0,0));var b=this._rect;
b.x=a.x;b.y=a.y;b.width=a.width;b.height=a.height;this._rectInPixels=cc.rectPointsToPixels(b)},getOffsetInPixels:function(){return cc.p(this._offsetInPixels)},setOffsetInPixels:function(a){this._offsetInPixels.x=a.x;this._offsetInPixels.y=a.y;cc._pointPixelsToPointsOut(this._offsetInPixels,this._offset)},getOriginalSizeInPixels:function(){return cc.size(this._originalSizeInPixels)},setOriginalSizeInPixels:function(a){this._originalSizeInPixels.width=a.width;this._originalSizeInPixels.height=a.height},
getOriginalSize:function(){return cc.size(this._originalSize)},setOriginalSize:function(a){this._originalSize.width=a.width;this._originalSize.height=a.height},getTexture:function(){if(this._texture)return this._texture;if(""!==this._textureFilename){var a=cc.textureCache.addImage(this._textureFilename);a&&(this._textureLoaded=a.isLoaded());return a}return null},setTexture:function(a){if(this._texture!=a){var b=a.isLoaded();this._textureLoaded=b;this._texture=a;b||a.addLoadedEventListener(function(a){this._textureLoaded=
...
startWithTarget:function(a){cc.ActionInterval.prototype.startWithTarget.call(this,a)},update:function(a){this.target instanceof cc.ProgressTimer&&(this.target.percentage=this._from+(this._to-this._from)*a)}});cc.progressFromTo=function(a,b,c){return new cc.ProgressFromTo(a,b,c)};cc.ProgressFromTo.create=cc.progressFromTo;var res={background_png:"res/background.jpg",map_png:"res/map.png",line_png:"res/line.png",firstPage_png:"res/firstPage.png",firstPage_plist:"res/firstPage.plist",secondPage_png:"res/secondPage.png",secondPage_plist:"res/secondPage.plist",thirdPage_png:"res/thirdPage.png",thirdPage_plist:"res/thirdPage.plist",forthPage_png:"res/forthPage.png",forthPage_plist:"res/forthPage.plist",fifPage_png:"res/fifthPage.png",fifPage_plist:"res/fifthPage.plist"},g_resources=[],i;for(i in res)g_resources.push(res[i]);var canChangePage=!0,actionList=[],curScene=null,MainScene=cc.Scene.extend({listener:null,accelListener:null,currentIndex:0,sceneList:[],ctor:function(){this._super();cc.spriteFrameCache.addSpriteFrames(res.firstPage_plist)},onEnter:function(){this._super();this.initUI();this.addTouch();this.initHideEvent();curScene=this;initMusic();playMusic(!0)},initUI:function(){var a=new cc.Sprite(res.background_png);a.anchorX=0;a.anchorY=0;a.scaleX=cc.winSize.width/a.width;a.scaleY=cc.winSize.height/a.height;
this.addChild(a,0);this.menuItemToggle=new cc.MenuItemToggle(new cc.MenuItemImage("#music.png"),new cc.MenuItemImage("#music_sel.png"),this.toggleCallback,this);this.menuItemToggle.setPosition(cc.pAdd(cc.visibleRect.right,cc.p(-this.menuItemToggle.width/2-30,140)));a=new cc.Menu(this.menuItemToggle);a.anchorX=0;a.anchorY=0;a.x=0;a.y=0;this.addChild(a,1);this.animLayer=new cc.Layer;this.addChild(this.animLayer);this.sceneList.push(new Scene1);this.sceneList.push(new Scene2);this.sceneList.push(new Scene3);
this.sceneList.push(new Scene4);this.sceneList.push(new Scene5);for(a=0;a<this.sceneList.length;a++){var b=this.sceneList[a];b.anchorX=0;b.anchorY=0;b.x=0;b.y=0;this.currentIndex!=a&&b.setVisible(!1);this.animLayer.addChild(b,this.sceneList.length-a)}this.arrow=new cc.Sprite("#arrow.png");this.arrow.setPosition(cc.pAdd(cc.visibleRect.bottom,cc.p(0,50)));a=cc.repeatForever(cc.sequence(cc.spawn(cc.moveTo(0.8,cc.p(this.arrow.x,this.arrow.y+30)).easing(cc.easeIn(0.5)),cc.fadeOut(1)),cc.delayTime(0.8),
cc.callFunc(function(){this.arrow.y-=30;this.arrow.opacity=255},this)));this.arrow.runAction(a);this.addChild(this.arrow,1)},initHideEvent:function(){cc.eventManager.addCustomListener(cc.game.EVENT_SHOW,function(){playMusic(!0)});cc.eventManager.addCustomListener(cc.game.EVENT_HIDE,function(){playMusic(!1)})},toggleCallback:function(a){0==a.getSelectedIndex()?playMusic(!0):playMusic(!1)},togleArrow:function(a){this.arrow.visible=a?!0:!1},addTouch:function(){var a=this;a.listener=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,
swallowTouches:!0,startPosY:0,onTouchBegan:function(a,c){this.startPosY=a.getLocation().y;return!0},onTouchMoved:function(a,c){},onTouchEnded:function(b,c){musicPlayStatus&&playMusic(!0);if(canChangePage){var d=b.getLocation().y-this.startPosY;15<d&&a.currentIndex<a.sceneList.length-1?a.changePage(++a.currentIndex,!0):-15>d&&0<a.currentIndex&&a.changePage(--a.currentIndex,!1)}},onTouchCancelled:function(a,c){}});cc.eventManager.addListener(a.listener,a)},addAccel:function(){var a=this;cc.inputManager.setAccelerometerInterval(1/
30);cc.inputManager.setAccelerometerEnabled(!0);this.accelListener={event:cc.EventListener.ACCELERATION,callback:function(b,c){for(var d=0;d<a.sceneList.length;++d)a.sceneList[d].accelEvent(b,c)}};cc.eventManager.addListener(this.accelListener,a)},changePage:function(a,b){canChangePage=!1;var c=b?this.sceneList[a-1]:this.sceneList[a+1];4==a?this.togleArrow(!1):this.togleArrow(!0);c&&c.disappear(function(){c.visible=!1;this.sceneList[a].visible=!0;this.sceneList[a].appear()},this)}}),Scene1=cc.Layer.extend({ctor:function(){this._super();
this.initUI()},onEnter:function(){this._super();this.appear()},initUI:function(){canChangePage=!1;this.accLayer=new cc.Layer;this.accLayer.anchorX=0;this.accLayer.anchorY=0;this.accLayer.x=0;this.accLayer.y=0;this.addChild(this.accLayer);this.logo=new cc.Sprite("#logo.png");this.logo.scale=0;this.logo.setPosition(cc.pAdd(cc.visibleRect.center,cc.p(0,this.logo.height/3*2)));this.addChild(this.logo);this.leftFont=new cc.Sprite("#font_left.png");this.leftFont.setPosition(cc.pAdd(cc.visibleRect.left,
cc.p(-this.leftFont.width/2,-this.leftFont.height/2)));this.addChild(this.leftFont);this.rightFont=new cc.Sprite("#font_right.png");this.rightFont.setPosition(cc.pAdd(cc.visibleRect.right,cc.p(this.rightFont.width/2,-this.rightFont.height/2)));this.addChild(this.rightFont);this.leftUpPic=new cc.Sprite("#block_left up.png");this.leftUpPic.anchorX=0;this.leftUpPic.anchorY=1;this.leftUpPic.setPosition(cc.pAdd(cc.visibleRect.topLeft,cc.p(-this.leftUpPic.width,this.leftUpPic.height)));this.accLayer.addChild(this.leftUpPic);
this.leftDownPic=new cc.Sprite("#block_left down.png");this.leftDownPic.anchorX=0;this.leftDownPic.anchorY=0;this.leftDownPic.setPosition(cc.pAdd(cc.visibleRect.bottomLeft,cc.p(-this.leftDownPic.width+20,-this.leftDownPic.height)));this.accLayer.addChild(this.leftDownPic);this.rightUpPic=new cc.Sprite("#block_right up.png");this.rightUpPic.anchorX=1;this.rightUpPic.anchorY=1;this.rightUpPic.setPosition(cc.pAdd(cc.visibleRect.topRight,cc.p(this.rightUpPic.width,this.rightUpPic.height)));this.accLayer.addChild(this.rightUpPic);
this.rightDownPic=new cc.Sprite("#block_right down.png");this.rightDownPic.anchorX=1;this.rightDownPic.anchorY=0;this.rightDownPic.setPosition(cc.pAdd(cc.visibleRect.bottomRight,cc.p(this.rightDownPic.width,-this.rightDownPic.height)));this.accLayer.addChild(this.rightDownPic)},accelEvent:function(a,b){this.visible&&movArea(a,this.accLayer)},appear:function(){var a=cc.sequence(cc.scaleTo(0.5,1),cc.callFunc(function(){this.leftUpPic.leftUpAction=cc.moveTo(0.5,cc.p(this.leftUpPic.x+this.leftUpPic.width,
this.leftUpPic.y-this.leftUpPic.height+80));this.leftUpPic.runAction(this.leftUpPic.leftUpAction);this.leftUpPic.oriX=this.leftUpPic.x;this.leftUpPic.oriY=this.leftUpPic.y;this.leftDownPic.leftDownAction=cc.moveTo(0.5,cc.p(this.leftDownPic.x+this.leftDownPic.width,this.leftDownPic.y+this.leftDownPic.height));this.leftDownPic.runAction(this.leftDownPic.leftDownAction);this.rightUpPic.rightUpAction=cc.moveTo(0.5,cc.p(this.rightUpPic.x-this.rightUpPic.width-30,this.rightUpPic.y-this.rightUpPic.height-
30));this.rightUpPic.runAction(this.rightUpPic.rightUpAction);this.rightDownPic.rightDownAction=cc.moveTo(0.5,cc.p(this.rightDownPic.x-this.rightDownPic.width,this.rightDownPic.y+this.rightDownPic.height));this.rightDownPic.runAction(this.rightDownPic.rightDownAction);this.leftFont.fontLeftAction=cc.sequence(cc.delayTime(0.3),cc.moveTo(0.5,cc.p(this.leftFont.x+this.leftFont.width,this.leftFont.y)));this.leftFont.runAction(this.leftFont.fontLeftAction);this.rightFont.fontRightAction=cc.sequence(cc.delayTime(0.4),
cc.moveTo(0.4,cc.p(this.rightFont.x-this.rightFont.width,this.rightFont.y)));this.rightFont.runAction(this.rightFont.fontRightAction)},this),cc.delayTime(1.3),cc.callFunc(function(){canChangePage=!0},this));this.logo.runAction(a)},disappear:function(a,b){var c=cc.sequence(cc.scaleTo(0.5,0),cc.callFunc(function(){this.leftUpPic.runAction(this.leftUpPic.leftUpAction.reverse());this.leftDownPic.runAction(this.leftDownPic.leftDownAction.reverse());this.rightUpPic.runAction(this.rightUpPic.rightUpAction.reverse());
this.rightDownPic.runAction(this.rightDownPic.rightDownAction.reverse());this.leftFont.runAction(this.leftFont.fontLeftAction.reverse());this.rightFont.runAction(this.rightFont.fontRightAction.reverse())},this),cc.delayTime(0.9),cc.callFunc(function(){b&&a&&a.call(b)},this));this.logo.runAction(c)}}),Scene2=cc.Layer.extend({ctor:function(){this._super()},onEnter:function(){this._super();cc.spriteFrameCache.addSpriteFrames(res.secondPage_plist);this.initUI()},initUI:function(){this.accLayer=new cc.Layer;
this.accLayer.anchorX=0;this.accLayer.anchorY=0;this.accLayer.x=0;this.accLayer.y=0;this.addChild(this.accLayer);this.lineLeftUp=new cc.Sprite("#line_left up.png");this.lineLeftUp.setPosition(cc.pAdd(cc.visibleRect.topLeft,cc.p(-this.lineLeftUp.width/2,-this.lineLeftUp.height)));this.addChild(this.lineLeftUp);this.blockLeftUp=new cc.Sprite("#block_left_up.png");this.blockLeftUp.setPosition(cc.pAdd(cc.visibleRect.topLeft,cc.p(-this.blockLeftUp.width/2,-this.blockLeftUp.height)));this.accLayer.addChild(this.blockLeftUp);
this.lineRightDown=new cc.Sprite("#line_right down.png");this.lineRightDown.setPosition(cc.pAdd(cc.visibleRect.bottomRight,cc.p(this.lineRightDown.width/2,this.lineRightDown.height/2*3)));this.addChild(this.lineRightDown);this.blockRightDown=new cc.Sprite("#block_right_down.png");this.blockRightDown.setPosition(cc.pAdd(cc.visibleRect.bottomRight,cc.p(this.blockRightDown.width/2,this.blockRightDown.height/2*3)));this.accLayer.addChild(this.blockRightDown);this.lineLeftDown=new cc.Sprite("#line_left down.png");
this.lineLeftDown.setPosition(cc.pAdd(cc.visibleRect.bottomLeft,cc.p(-this.lineLeftDown.width/2,-this.lineLeftDown.height/2)));this.addChild(this.lineLeftDown);this.blockLeftDown=new cc.Sprite("#block_left_down.png");this.blockLeftDown.setPosition(cc.pAdd(cc.visibleRect.bottomLeft,cc.p(-this.blockLeftDown.width/2,-this.blockLeftDown.height/2)));this.accLayer.addChild(this.blockLeftDown);this.lineRightUp=new cc.Sprite("#line_right up.png");this.lineRightUp.setPosition(cc.pAdd(cc.visibleRect.topRight,
cc.p(this.lineRightUp.width/2,this.lineRightUp.height/2)));this.addChild(this.lineRightUp);this.blockRightUp=new cc.Sprite("#block_right_up.png");this.blockRightUp.setPosition(cc.pAdd(cc.visibleRect.topRight,cc.p(this.blockRightUp.width/2,this.blockRightUp.height/2)));this.accLayer.addChild(this.blockRightUp);this.fontLogo=new cc.Sprite("#font.png");this.fontLogo.setPosition(cc.pAdd(cc.visibleRect.center,cc.p(0,0)));this.fontLogo.setScale(0);this.addChild(this.fontLogo)},accelEvent:function(a,b){this.visible&&
movArea(a,this.accLayer)},appear:function(){var a=cc.sequence(cc.scaleTo(0.5,0.8),cc.callFunc(function(){this.blockLeftUp.leftUpAction=cc.moveTo(0.3,cc.p(this.blockLeftUp.x+this.blockLeftUp.width+20,this.blockLeftUp.y+this.blockLeftUp.height/2-20));this.blockLeftUp.runAction(this.blockLeftUp.leftUpAction);this.lineLeftUp.leftUpAction=cc.moveTo(0.3,cc.p(this.lineLeftUp.x+this.lineLeftUp.width,this.lineLeftUp.y+this.lineLeftUp.height/2));this.lineLeftUp.runAction(this.lineLeftUp.leftUpAction);this.blockRightDown.rightDownAction=
cc.moveTo(0.3,cc.p(this.blockRightDown.x-this.blockRightDown.width-20,this.blockRightDown.y-this.blockRightDown.height-20));this.blockRightDown.runAction(this.blockRightDown.rightDownAction);this.lineRightDown.rightDownAction=cc.moveTo(0.3,cc.p(this.lineRightDown.x-this.lineRightDown.width,this.lineRightDown.y-this.lineRightDown.height));this.lineRightDown.runAction(this.lineRightDown.rightDownAction);this.lineLeftDown.leftDownAction=cc.sequence(cc.delayTime(0.3),cc.moveTo(0.3,cc.p(this.lineLeftDown.x+
this.lineLeftDown.width+20,this.lineLeftDown.y+this.lineLeftDown.height+20)));this.lineLeftDown.runAction(this.lineLeftDown.leftDownAction);this.blockLeftDown.leftDownAction=cc.sequence(cc.delayTime(0.3),cc.moveTo(0.3,cc.p(this.blockLeftDown.x+this.blockLeftDown.width,this.blockLeftDown.y+this.blockLeftDown.height)));this.blockLeftDown.runAction(this.blockLeftDown.leftDownAction);this.blockRightUp.rightUpAction=cc.sequence(cc.delayTime(0.3),cc.moveTo(0.3,cc.p(this.blockRightUp.x-this.blockRightUp.width-
20,this.blockRightUp.y-this.blockRightUp.height-20)));this.blockRightUp.runAction(this.blockRightUp.rightUpAction);this.lineRightUp.rightUpAction=cc.sequence(cc.delayTime(0.3),cc.moveTo(0.3,cc.p(this.lineRightUp.x-this.lineRightUp.width,this.lineRightUp.y-this.lineRightUp.height)));this.lineRightUp.runAction(this.lineRightUp.rightUpAction)},this),cc.delayTime(0.8),cc.callFunc(function(){canChangePage=!0},this));this.fontLogo.runAction(a)},disappear:function(a,b){var c=cc.sequence(cc.scaleTo(0.5,0),
cc.callFunc(function(){this.blockLeftUp.runAction(this.blockLeftUp.leftUpAction.reverse());this.lineLeftUp.runAction(this.lineLeftUp.leftUpAction.reverse());this.blockRightDown.runAction(this.blockRightDown.rightDownAction.reverse());this.lineRightDown.runAction(this.lineRightDown.rightDownAction.reverse());this.lineLeftDown.runAction(this.lineLeftDown.leftDownAction.reverse());this.blockLeftDown.runAction(this.blockLeftDown.leftDownAction.reverse());this.blockRightUp.runAction(this.blockRightUp.rightUpAction.reverse());
this.lineRightUp.runAction(this.lineRightUp.rightUpAction.reverse())},this),cc.delayTime(0.8),cc.callFunc(function(){b&&a&&a.call(b)},this));this.fontLogo.runAction(c)}}),Scene3=cc.Layer.extend({speed:200,ctor:function(){this._super()},onEnter:function(){this._super();cc.spriteFrameCache.addSpriteFrames(res.thirdPage_plist);this.initUI()},initUI:function(){this.accLayer=new cc.Layer;this.accLayer.anchorX=0;this.accLayer.anchorY=0;this.accLayer.x=0;this.accLayer.y=0;this.addChild(this.accLayer);this.leftUpPic=
new cc.Sprite("#block_left_up2.png");this.leftUpPic.setPosition(cc.pAdd(cc.visibleRect.topLeft,cc.p(-this.leftUpPic.width/2,this.leftUpPic.height/2)));this.accLayer.addChild(this.leftUpPic);this.leftDownPic=new cc.Sprite("#block_left_down2.png");this.leftDownPic.setPosition(cc.pAdd(cc.visibleRect.bottomLeft,cc.p(-this.leftDownPic.width/2,-this.leftDownPic.height/2)));this.accLayer.addChild(this.leftDownPic);this.rightUpPic=new cc.Sprite("#block_right_up2.png");this.rightUpPic.setPosition(cc.pAdd(cc.visibleRect.topRight,
cc.p(this.rightUpPic.width/2,-this.rightUpPic.height/2)));this.accLayer.addChild(this.rightUpPic);this.rightDownPic=new cc.Sprite("#block_right_down2.png");this.rightDownPic.setPosition(cc.pAdd(cc.visibleRect.bottomRight,cc.p(this.rightDownPic.width/2,-this.rightDownPic.height/2)));this.accLayer.addChild(this.rightDownPic);this.line=new cc.ProgressTimer(new cc.Sprite(res.line_png));this.line.type=cc.ProgressTimer.TYPE_BAR;this.line.midPoint=cc.p(0,1);this.line.barChangeRate=cc.p(0,1);this.line.percentage=
0;this.line.setPosition(cc.p(cc.winSize.width/2-30,cc.winSize.height-this.line.height/2));this.addChild(this.line);this.firstPoint=new cc.Sprite("#circle_red.png");this.firstPoint.setPosition(cc.p(35,this.line.height-111));this.firstPoint.scale=0;this.line.addChild(this.firstPoint);this.firstText=new cc.Sprite("#morning font.png");this.firstText.setPosition(cc.p(this.firstPoint.x+this.firstPoint.width/2+20+this.firstText.width,this.firstPoint.y-50));this.firstText.opacity=0;this.line.addChild(this.firstText);
this.secondPoint=new cc.Sprite("#circle_org.png");this.secondPoint.setPosition(cc.p(395,395));this.secondPoint.scale=0;this.line.addChild(this.secondPoint);this.secondText=new cc.Sprite("#Afternoon font.png");this.secondText.setPosition(cc.p(this.secondPoint.x-this.firstPoint.width/2-20-this.secondText.width,this.secondPoint.y-20));this.secondText.opacity=0;this.line.addChild(this.secondText);this.thirdPoint=new cc.Sprite("#circle_green.png");this.thirdPoint.setPosition(cc.p(15,168));this.thirdPoint.scale=
0;this.line.addChild(this.thirdPoint);this.thirdText=new cc.Sprite("#all day font.png");this.thirdText.setPosition(cc.p(this.thirdPoint.x+this.thirdPoint.width/2+20+this.thirdText.width,this.thirdPoint.y-22));this.thirdText.opacity=0;this.line.addChild(this.thirdText);this.forthPoint=new cc.Sprite("#circle_end.png");this.forthPoint.setPosition(cc.p(150,-this.forthPoint.height/2+5));this.line.addChild(this.forthPoint);this.forthPoint.scale=0},accelEvent:function(a,b){this.visible&&movArea(a,this.accLayer)},
appear:function(){this.leftUpPic.inAciton=cc.moveTo(0.2,cc.p(this.leftUpPic.x+this.leftUpPic.width+20,this.leftUpPic.y-this.leftUpPic.height+20));this.leftUpPic.runAction(this.leftUpPic.inAciton);this.leftDownPic.inAciton=cc.moveTo(0.2,cc.p(this.leftDownPic.x+this.leftDownPic.width+20,this.leftDownPic.y+this.leftDownPic.height+20));this.leftDownPic.runAction(this.leftDownPic.inAciton);this.rightUpPic.inAciton=cc.moveTo(0.2,cc.p(this.rightUpPic.x-this.rightUpPic.width-30,this.rightUpPic.y-this.rightUpPic.height-
30));this.rightUpPic.runAction(this.rightUpPic.inAciton);this.rightDownPic.inAciton=cc.moveTo(0.2,cc.p(this.rightDownPic.x-this.rightDownPic.width-20,this.rightDownPic.y+this.rightDownPic.height+80));this.rightDownPic.runAction(this.rightDownPic.inAciton);var a=cc.sequence(cc.delayTime(0.2),cc.progressTo(0.3,20),cc.callFunc(function(){this.firstPoint.inAction=cc.scaleTo(0.2,1);this.firstPoint.runAction(this.firstPoint.inAction);this.firstText.inAction=cc.sequence(cc.delayTime(0.2),cc.spawn(cc.moveTo(0.2,
cc.p(this.firstText.x-this.firstText.width/2,this.firstText.y)),cc.fadeIn(0.5)));this.firstText.runAction(this.firstText.inAction)},this),cc.delayTime(0.7),cc.progressTo(0.3,50),cc.callFunc(function(){this.secondPoint.inAction=cc.scaleTo(0.2,1);this.secondPoint.runAction(this.secondPoint.inAction);this.secondText.inAction=cc.sequence(cc.delayTime(0.2),cc.spawn(cc.moveTo(0.2,cc.p(this.secondText.x+this.secondText.width/2,this.secondText.y)),cc.fadeIn(0.5)));this.secondText.runAction(this.secondText.inAction)},
this),cc.delayTime(0.7),cc.progressTo(0.3,80),cc.callFunc(function(){this.thirdPoint.inAction=cc.scaleTo(0.2,1);this.thirdPoint.runAction(this.thirdPoint.inAction);this.thirdText.inAction=cc.sequence(cc.delayTime(0.2),cc.spawn(cc.moveTo(0.2,cc.p(this.thirdText.x-this.thirdText.width/2,this.thirdText.y)),cc.fadeIn(0.5)));this.thirdText.runAction(this.thirdText.inAction)},this),cc.delayTime(0.7),cc.progressTo(0.3,100),cc.callFunc(function(){this.forthPoint.inAction=cc.scaleTo(0.2,1);this.forthPoint.runAction(this.forthPoint.inAction);
canChangePage=!0},this));this.line.runAction(a)},disappear:function(a,b){this.leftUpPic.runAction(this.leftUpPic.inAciton.reverse());this.leftDownPic.runAction(this.leftDownPic.inAciton.reverse());this.rightUpPic.runAction(this.rightUpPic.inAciton.reverse());this.rightDownPic.runAction(this.rightDownPic.inAciton.reverse());this.forthPoint.inAction=cc.sequence(cc.delayTime(0.2),cc.scaleTo(0.2,0));this.forthPoint.runAction(this.forthPoint.inAction);var c=cc.sequence(cc.progressFromTo(0.5,100,0),cc.delayTime(0.5),
cc.callFunc(function(){b&&a&&a.call(b)},this));this.line.runAction(c);this.thirdPoint.inAction=cc.sequence(cc.delayTime(0.2),cc.scaleTo(0.2,0));this.thirdPoint.runAction(this.thirdPoint.inAction);this.thirdText.inAction=cc.spawn(cc.moveTo(0.3,cc.p(this.thirdText.x+this.thirdText.width/2,this.thirdText.y)),cc.fadeOut(0.3));this.thirdText.runAction(this.thirdText.inAction);this.secondPoint.inAction=cc.sequence(cc.delayTime(0.2),cc.scaleTo(0.2,0));this.secondPoint.runAction(this.secondPoint.inAction);
this.secondText.inAction=cc.spawn(cc.moveTo(0.5,cc.p(this.secondText.x-this.secondText.width/2,this.secondText.y)),cc.fadeOut(0.3));this.secondText.runAction(this.secondText.inAction);this.firstPoint.inAction=cc.sequence(cc.delayTime(0.2),cc.scaleTo(0.2,0));this.firstPoint.runAction(this.firstPoint.inAction);this.firstText.inAction=cc.spawn(cc.moveTo(0.3,cc.p(this.firstText.x+this.firstText.width/2,this.firstText.y)),cc.fadeOut(0.3));this.firstText.runAction(this.firstText.inAction)}}),Scene4=cc.Layer.extend({ctor:function(){this._super()},
onEnter:function(){this._super();cc.spriteFrameCache.addSpriteFrames(res.forthPage_plist);this.initUI()},initUI:function(){this.accLayer=new cc.Layer;this.accLayer.anchorX=0;this.accLayer.anchorY=0;this.accLayer.x=0;this.accLayer.y=0;this.addChild(this.accLayer);this.map=new cc.Sprite(res.map_png);this.accLayer.addChild(this.map);this.map.setPosition(cc.pAdd(cc.visibleRect.top,cc.p(0,this.map.height/2)));this.greenDot=new cc.Sprite("#destination_1.png");this.map.addChild(this.greenDot);this.greenDot.setPosition(cc.p(145,
305));var a=cc.repeatForever(cc.sequence(cc.animate(new cc.Animation([cc.spriteFrameCache.getSpriteFrame("destination_1.png"),cc.spriteFrameCache.getSpriteFrame("destination_2.png")],0.3)),cc.delayTime(0.5)));this.greenDot.runAction(a);this.timeAngle=new cc.Sprite("#light_2.png");this.time=new cc.Sprite("#time.png");this.time.setPosition(cc.p(this.time.width-18,this.time.height/2-23));this.timeAngle.addChild(this.time);this.timeAngle.setPosition(cc.p(this.greenDot.x+this.greenDot.width/2+this.timeAngle.width/
2+4,this.greenDot.y+11));this.map.addChild(this.timeAngle);this.timeAngle.scale=0;this.registerBtn=new cc.MenuItemImage("#button_normal.png","#button_hover.png",this.registerClick,this);this.registerBtn.setPosition(cc.pAdd(cc.visibleRect.bottom,cc.p(0,-this.registerBtn.height/2)));a=new cc.Menu(this.registerBtn);a.x=0;a.y=0;this.addChild(a)},registerClick:function(){var a=getById("regPage");removeClass(a,"hide");removeClass(a,"animOut");addClass(a,"anim");var b=getById("Cocos2dGameContainer");addClass(b,
"hide");setTimeout(function(){removeClass(a,"anim")},800)},accelEvent:function(a,b){this.visible&&movArea(a,this.accLayer)},appear:function(){this.map.mapAction=cc.moveTo(0.5,cc.p(this.map.x,this.map.y-this.map.height)).easing(cc.easeIn(0.5));this.map.runAction(this.map.mapAction);this.registerBtn.inAction=cc.moveTo(0.5,cc.p(this.registerBtn.x,this.registerBtn.y+this.registerBtn.height/2+160)).easing(cc.easeIn(0.5));this.registerBtn.runAction(this.registerBtn.inAction);this.timeAngle.inAction=cc.sequence(cc.delayTime(0.5),
cc.scaleTo(0.3,1),cc.delayTime(0.3),cc.callFunc(function(){canChangePage=!0},this));this.timeAngle.runAction(this.timeAngle.inAction)},disappear:function(a,b){var c=cc.scaleTo(0.3,0);this.timeAngle.runAction(c);c=cc.sequence(cc.delayTime(0.3),cc.moveTo(0.5,cc.p(this.registerBtn.x,this.registerBtn.y-this.registerBtn.height/2-160)).easing(cc.easeIn(0.5)));this.registerBtn.runAction(c);c=cc.sequence(cc.delayTime(0.3),cc.moveTo(0.5,cc.p(this.map.x,this.map.y+this.map.height)).easing(cc.easeIn(0.5)),cc.delayTime(0.6),
cc.callFunc(function(){b&&a&&a.call(b)},this));this.map.runAction(c)}}),Scene5=cc.Layer.extend({ctor:function(){this._super()},onEnter:function(){this._super();cc.spriteFrameCache.addSpriteFrames(res.fifPage_plist);this.initUI()},initUI:function(){this.accLayer=new cc.Layer;this.accLayer.anchorX=0;this.accLayer.anchorY=0;this.accLayer.x=0;this.accLayer.y=0;this.addChild(this.accLayer);this.leftUp=new cc.Sprite("#left_up.png");this.leftUp.setPosition(cc.pAdd(cc.visibleRect.topLeft,cc.p(-this.leftUp.width/
2,3*-this.leftUp.height/2)));this.accLayer.addChild(this.leftUp);this.leftDown=new cc.Sprite("#left_down.png");this.leftDown.setPosition(cc.pAdd(cc.visibleRect.bottomLeft,cc.p(-this.leftDown.width/2,-this.leftDown.height/2)));this.accLayer.addChild(this.leftDown);this.rightUp=new cc.Sprite("#right_up.png");this.rightUp.setPosition(cc.pAdd(cc.visibleRect.topRight,cc.p(this.rightUp.width/2,this.rightUp.height/2)));this.accLayer.addChild(this.rightUp);this.rightDown=new cc.Sprite("#right_down.png");
this.rightDown.setPosition(cc.pAdd(cc.visibleRect.bottomRight,cc.p(this.rightDown.width/2,3*this.rightDown.height/2)));this.accLayer.addChild(this.rightDown);this.code=new cc.Sprite("#code.png");this.code.setPosition(cc.pAdd(cc.visibleRect.top,cc.p(0,this.code.height/2)));this.addChild(this.code);this.text=new cc.Sprite("#focus.png");this.text.setPosition(cc.pAdd(cc.visibleRect.left,cc.p(-this.text.width/2,-20)));this.addChild(this.text);this.shareText=new cc.Sprite("#share.png");this.shareText.setPosition(cc.pAdd(cc.visibleRect.bottomLeft,
cc.p(this.shareText.width/2+30,-this.shareText.height/2)));this.addChild(this.shareText)},appear:function(){this.leftUp.moveAction=cc.moveTo(0.2,cc.p(this.leftUp.x+this.leftUp.width,this.leftUp.y+this.leftUp.height/2));this.leftUp.runAction(this.leftUp.moveAction);this.rightDown.moveAction=cc.moveTo(0.2,cc.p(this.rightDown.x-this.rightDown.width,this.rightDown.y-this.rightDown.height));this.rightDown.runAction(this.rightDown.moveAction);this.leftDown.moveAction=cc.sequence(cc.delayTime(0.2),cc.moveTo(0.2,
cc.p(this.leftDown.x+this.leftDown.width,this.leftDown.y+this.leftDown.height+30)));this.leftDown.runAction(this.leftDown.moveAction);this.rightUp.moveAction=cc.sequence(cc.delayTime(0.2),cc.moveTo(0.2,cc.p(this.rightUp.x-this.rightUp.width,this.rightUp.y-this.rightUp.height)));this.rightUp.runAction(this.rightUp.moveAction);this.code.moveAction=cc.sequence(cc.delayTime(0.5),cc.moveTo(0.2,cc.p(this.code.x,this.code.y-this.code.height-80)));this.code.runAction(this.code.moveAction);this.shareText.moveAction=
cc.sequence(cc.delayTime(0.5),cc.moveTo(0.2,cc.p(this.shareText.x+40,this.shareText.y+this.shareText.height+20)));this.shareText.runAction(this.shareText.moveAction);this.text.moveAction=cc.sequence(cc.delayTime(0.7),cc.moveTo(0.2,cc.p(cc.visibleRect.center.x+20,this.text.y)).easing(cc.easeIn(0.8)),cc.moveTo(0.05,cc.p(cc.visibleRect.center.x,this.text.y)).easing(cc.easeIn(0.8)),cc.delayTime(0.25),cc.callFunc(function(){canChangePage=!0},this));this.text.runAction(this.text.moveAction)},disappear:function(a,
b){var c=cc.sequence(cc.moveTo(0.2,cc.p(cc.visibleRect.left.x-this.text.width/2,this.text.y)).easing(cc.easeOut(0.8)),cc.delayTime(0.3),cc.callFunc(function(){this.leftUp.runAction(this.leftUp.moveAction.reverse());this.rightDown.runAction(this.rightDown.moveAction.reverse());this.leftDown.runAction(this.leftDown.moveAction.reverse());this.rightUp.runAction(this.rightUp.moveAction.reverse());this.code.runAction(this.code.moveAction.reverse());this.shareText.runAction(this.shareText.moveAction.reverse())},
this),cc.delayTime(0.3),cc.callFunc(function(){b&&a&&a.call(b)},this));this.text.runAction(c)}}),movArea=function(a,b){var c=b.x+20*a.x,d=b.y+20*a.y;b.x=7>Math.abs(c)?c:b.x;b.y=7>Math.abs(d)?d:b.y},getShake=function(a){if(0==actionList.length){var b=cc.sequence(cc.repeat(cc.sequence(cc.moveBy(0.02,cc.p(0,1.2)),cc.moveBy(0.02,cc.p(0,-1.2)),cc.delayTime(0.1)),3),cc.sequence(cc.moveBy(0.02,cc.p(1.2,0)),cc.moveBy(0.02,cc.p(-1.2,0)),cc.delayTime(0.1))).repeatForever(),c=cc.repeatForever(cc.sequence(cc.moveBy(0.2,
cc.p(0,2)),cc.moveBy(0.2,cc.p(0,0)),cc.moveBy(0.2,cc.p(-2,0)),cc.moveBy(0.2,cc.p(0,0)))),d=cc.repeatForever(cc.sequence(cc.moveBy(0.25,cc.p(0,2)),cc.moveBy(0.02,cc.p(0,0)),cc.moveBy(0.03,cc.p(0,2)),cc.moveBy(0.03,cc.p(0,0)))),e=cc.repeatForever(cc.sequence(cc.moveBy(0.35,cc.p(0,2)),cc.moveBy(0.02,cc.p(0,0)),cc.moveBy(0.03,cc.p(-2,0)),cc.moveBy(0.03,cc.p(0,0))));actionList.push(b);actionList.push(c);actionList.push(d);actionList.push(e)}return actionList[a].clone()},testScene=cc.Scene.extend({ctor:function(){this._super()},
onEnter:function(){this._super();var a=new Scene4;this.addChild(a);a.appear()}}),reclick=!0,isSuccess=!1,musicPlayStatus=!0,getById=function(a){return document.getElementById(a)},moveIn=function(){getById()};function hasClass(a,b){return!(!a||!a.className||-1==a.className.search(RegExp("(\\s|^)"+b+"(\\s|$)")))}function addClass(a,b){!hasClass(a,b)&&a&&(a.className+=" "+b)}function removeClass(a,b){hasClass(a,b)&&(a.className=a.className.replace(RegExp("(\\s|^)"+b+"(\\s|$)")," "))}
function getElementsByClass(a){for(var b=[],c=document.getElementsByTagName("*"),d=0;d<c.length;d++)hasClass(c[d],a)&&b.push(c[d]);return b}window.onCloseClick=function(){removeClass(getById("regPage"),"anim");addClass(getById("regPage"),"animOut");var a=getById("Cocos2dGameContainer");removeClass(a,"hide");setTimeout(function(){addClass(getById("regPage"),"hide")},300)};
window.onSubmitClick=function(){if(!reclick)return window.showAlert("\u7533\u8bf7\u53d1\u9001\u4e2d\uff0c\u8bf7\u52ff\u91cd\u590d\u53d1\u9001~"),!1;checkForm()&&(reclick=!1,post({realname:getById("realname").value.trim(),telephone:getById("telephone").value.trim(),email:getById("email").value.trim(),company:getById("company").value.trim(),position:getById("position").value.trim(),extra:getById("extra").value.trim(),from:"mobile"},function(a){var b="";1==a.status?(isSuccess=!0,b="\u60a8\u7684\u62a5\u540d\u4fe1\u606f\u5df2\u7ecf\u6210\u529f\u63d0\u4ea4"):
a.error&&(b=a.error.email_unique?a.error.email_unique:a.error.telephone_unique?a.error.telephone_unique:a.error.from?a.error.from:a.error.realname?a.error.realname:a.error.position?a.error.position:a.error.email?a.error.email:a.error.telephone?a.error.telephone:a.error.company?a.error.company:a.error&&"string"==typeof a.error?a.error:"\u672a\u77e5\u9519\u8bef");window.showAlert(b)}))};
window.onOkClick=function(){var a=getById("alertItem");removeClass(a,"alertAnimIn");addClass(a,"alertAnimOut");setTimeout(function(){addClass(a,"hide");isSuccess&&(isSuccess=!1,window.onCloseClick(),curScene&&curScene.changePage(++curScene.currentIndex,!0))},280)};window.showAlert=function(a){a||(a="");var b=getById("alertText"),c=getById("alertItem");b.innerHTML=a;removeClass(c,"alertAnimOut");addClass(c,"alertAnimIn");removeClass(c,"hide");setTimeout(function(){removeClass(c,"alertAnimIn")},300)};
var checkForm=function(){for(var a=!0,b=["realname","telephone","email","company","position"],c=[],d=0;d<b.length;d++)c[d]=getById(b[d]).value.trim();for(d=0;d<b.length;d++){var e=getById(b[d]);""==c[d]?(removeClass(e,"inputItem_normal"),addClass(e,"inputItem_error"),e.placeholder="\u6b64\u9879\u4e0d\u80fd\u4e3a\u7a7a",a=!1):(removeClass(e,"inputItem_error"),addClass(e,"inputItem_normal"))}d=/^[0-9]*[1-9][0-9]*$/;11==c[1].length&&d.test(c[1])?addClass(getById(b[2]),"inputItem_normal"):(e=getById(b[1]),
c[1]="",e.value="",e.placeholder="\u8bf7\u8f93\u5165\u6b63\u786e\u7684\u624b\u673a\u53f7\u7801",removeClass(e,"inputItem_normal"),addClass(e,"inputItem_error"),a=!1);/^([a-zA-Z0-9]+[_|\-|\.]?)*[a-zA-Z0-9]+@([a-zA-Z0-9]+[_|\-|\.]?)*[a-zA-Z0-9]+\.[a-zA-Z]{1,4}$/gi.test(c[2])?addClass(getById(b[2]),"inputItem_normal"):(e=getById(b[2]),c[2]="",e.value="",e.placeholder="\u8bf7\u8f93\u5165\u6b63\u786e\u7684\u90ae\u7bb1",removeClass(e,"inputItem_normal"),addClass(e,"inputItem_error"),a=!1);return a},post=
function(a,b){var c=cc.loader.getXMLHttpRequest(),d=window.location.host,d=encodeURIComponent(d);c.open("POST","http://devcon.cocos.com/main/form?url\x3d"+d,!0);c.setRequestHeader("Content-Type","application/x-www-form-urlencoded;");c.timeout=1E4;c.ontimeout=function(){reclick=!0};c.onreadystatechange=function(){4==c.readyState&&(reclick=!0);if(4==c.readyState&&200==c.status){var a=JSON.parse(c.responseText);b(a)}};var d="",e;for(e in a)d=d+e+"\x3d"+a[e]+"\x26";d=encodeURI(d);c.send(d)},initMusic=
function(){getById("myAudio").src="res/bg.mp3"},playMusic=function(a){var b=getById("myAudio");a?b.paused&&(b.play(),musicPlayStatus=!0):b.paused||(b.pause(),musicPlayStatus=!1)};cc.game.onStart=function(){cc.view.adjustViewPort(!0);cc.view.enableAutoFullScreen(!1);var a=cc.sys.isMobile&&-1!=window.navigator.userAgent.indexOf("MicroMessenger")?cc.ResolutionPolicy.FIXED_HEIGHT:cc.sys.isMobile?cc.ResolutionPolicy.FIXED_WIDTH:cc.ResolutionPolicy.SHOW_ALL;cc.view.setDesignResolutionSize(640,831,a);cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new MainScene)},this)};cc.game.run();